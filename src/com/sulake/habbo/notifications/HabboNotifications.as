package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1541:String = "pixelbalance";
      
      private static const const_1545:String = "badges";
      
      private static const const_1548:String = "selectbadge";
      
      private static const const_1544:String = "inventory";
      
      private static const const_1543:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1546:String = "friendlist";
      
      private static const const_1542:String = "pet_inventory";
      
      private static const const_1547:String = "go_to_room";
      ...
      private var var_834:ParkBusDialogManager;
      ...
      private var var_1027:ClubPromoNotification;
      
      private var var_3034:Dictionary;
      ...
      public function setQuestTrackerHeight(param1:int) : void
      {
         if(this.var_387)
         {
            this.var_387.topMarginIncrease = param1;
         }
      }
      ...
      {
         this.var_387 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1026["styles"],this.var_1026["view"]);
         ...
         registerUpdateReceiver(this.var_387,1);
         registerUpdateReceiver(this,2);
         this.var_408.events.addEventListener(BadgeImageReadyEvent.const_214,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_408.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1255,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1255,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1943,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_726,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_1030.createAvatarImage(param2,AvatarScaleType.const_61);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_408.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_408.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_408.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1345)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1743)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1028 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1027 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_387.isSpaceAvailable() && this.var_1269.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_387.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1545:
               if(this.var_13 != null)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_241);
               }
               break;
            case const_1548:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_387.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_834 == null)
         {
            this.var_834 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_834 != null)
         {
            this.var_834.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1251,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1251,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1030.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_39,3);
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2710)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_726,null);
            this.var_2710 = true;
      ...
      {
         if(param2.type == WindowEvent.const_181 || param2.type == WindowEvent.const_552)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         this.var_1029 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_726,_loc6_);
      }
   }
}
