package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1225:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_540 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_1225 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         ...
         {
            this.var_1225.load(_loc4_,this.var_170.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_74 != null && this.var_74.issueManager != null && this.var_170 != null)
         {
            this.var_74.issueManager.removeHandler(this.var_170.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_170.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_170.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_170.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.releaseBundle(this.var_170.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_74,WindowTracker.const_1198,_loc2_),this._window,false,false,true);
      }
