package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2571 = param2.pickerUserId;
         this.var_2833 = param2.pickerUserName;
         this.var_1569 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1338 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1337;
         }
         if(this.var_874 == null || param1.timeStamp < this.var_874.timeStamp)
         {
            this.var_874 = param1;
         }
         if(this.var_873 == null || param1.priority > this.var_873.timeStamp)
         {
            this.var_873 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_873;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_874;
         if(_loc2_ == null)
         {
