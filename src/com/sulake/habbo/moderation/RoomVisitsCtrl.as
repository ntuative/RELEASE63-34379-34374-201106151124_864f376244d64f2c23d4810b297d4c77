package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_989:Array = [];
      ...
      {
         this.var_798 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_989.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_798.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_989.length < var_1870)
         {
            ...
            param1.width = this.var_798.width;
            param1.height = this.var_798.height;
            var_989.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1502)
         {
