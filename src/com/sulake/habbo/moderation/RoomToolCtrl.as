package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1300:IDropMenuWindow;
      
      private var var_558:ITextFieldWindow;
      
      private var var_645:Boolean = true;
      
      private var var_1087:ICheckBoxWindow;
      
      private var var_1610:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_362));
         Logger.log("BEGINNING TO SHOW: " + this.var_362);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1873;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_558 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_558.procedure = this.onInputClick;
         this.var_1300 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1300);
         this.var_1300.procedure = this.onSelectTemplate;
         this.var_1087 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1610 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1611 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_977,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_645 || this.var_558.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1087.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1715,_loc2_,this.var_558.text,"",""));
         if(this.var_1610.isSelected || this.var_1611.isSelected || this.var_1087.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1610.isSelected,this.var_1611.isSelected,this.var_1087.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1979);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1942);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1300.selection];
         if(_loc3_ != null)
         {
            this.var_645 = false;
            this.var_558.text = _loc3_;
         }
      }
   }
}
