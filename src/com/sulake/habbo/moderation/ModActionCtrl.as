package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1033:OffenceCategoryData;
      
      private var var_1034:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1274 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1273 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1968;
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1033 != null;
         if(this.var_1034 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1034.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1033 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1033.offences,this.var_1274,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1273,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1557,this.var_558.text,this.var_1556));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1033 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1034 = this.var_1033.offences[_loc3_];
         this.var_558.text = this.var_1034.msg;
         this.var_645 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1557,this.var_558.text,this.var_1556));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1557,this.var_558.text,this.getBanLength(),this.var_1556));
         this.dispose();
      }
