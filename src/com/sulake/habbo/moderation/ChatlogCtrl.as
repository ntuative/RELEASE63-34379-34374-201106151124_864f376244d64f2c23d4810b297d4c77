package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1835:IMessageComposer;
      ...
      {
         this.var_789 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_790 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         ...
         this.var_36.connection.send(this.var_1835);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1836[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
