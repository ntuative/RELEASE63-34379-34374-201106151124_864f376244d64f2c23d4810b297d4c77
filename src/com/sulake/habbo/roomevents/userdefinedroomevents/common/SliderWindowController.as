package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1147:Number = 1.0;
      
      private var var_609:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1147,param1);
         this.var_939 = param1;
         if(param2)
         {
      ...
      {
         return int(this.var_1708 * (Number(param1 - this._minValue) / (this.var_1147 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1708 * (this.var_1147 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_940)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_296)
            {
               this.var_940 = false;
            }
         }
         if(!this.var_940 || param1.type != WindowEvent.const_396)
         {
            return;
         }
         if(this.var_609 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_609) * this.var_609;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_609 != 0)
            {
               _loc3_ = this.var_939 + this.var_609;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_747 != null)
            {
               ...
               this.var_1708 = _loc1_.width - _loc2_.width;
            }
         }
