package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1651:int = 2;
      ...
      private var var_2148:TriggerConfs;
      
      private var var_2147:ActionTypes;
      
      private var var_2146:ConditionTypes;
      
      private var var_301:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_902:RoomObjectHightLighter;
      
      private var var_195:UserDefinedRoomEventsHelp;
      
      private var var_1379:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2148 = new TriggerConfs();
         this.var_2147 = new ActionTypes();
         this.var_2146 = new ConditionTypes();
         this.var_301 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_902 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_301[param1])
         {
            delete this.var_301[param1];
            this.var_902.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_301[param1] = param2;
            this.var_902.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1379 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1379.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1379.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_902.hideAll(this.var_301);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1379.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1651) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1651 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2148);
         this.refreshConfigureElement(this.var_2147);
         this.refreshConfigureElement(this.var_2146);
