package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_634 != const_1061;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1852 != RecyclerStatusMessageEvent.const_1353;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_634 == const_469;
      }
      ...
      {
         this.var_634 = const_1062;
         this.var_126 = new Array(const_228);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1852)
         {
            case RecyclerStatusMessageEvent.const_1982:
               this.var_634 = const_469;
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1345:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1726:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_126.length < const_228)
         {
            return false;
         }
         var _loc1_:int = 0;
