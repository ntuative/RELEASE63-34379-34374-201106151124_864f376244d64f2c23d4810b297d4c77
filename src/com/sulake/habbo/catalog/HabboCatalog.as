package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_712:uint = 1;
      ...
      private var var_1270:IRoomSession;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_13:IHabboInventory;
      
      private var var_408:ISessionDataManager;
      
      private var var_1030:IAvatarRenderManager;
      ...
      private var var_346:ICatalogNavigator;
      
      private var var_121:Purse;
      ...
      private var var_2876:Boolean = true;
      
      private var var_2873:Boolean = true;
      
      private var var_2092:Boolean = false;
      
      private var var_2874:GiftWrappingConfiguration;
      
      private var var_1350:ClubGiftController;
      
      private var var_581:ClubBuyController;
      
      private var var_887:Map;
      
      private var var_1351:Boolean = false;
      
      private var var_886:IPurchasableOffer;
      
      private var var_1618:IDragAndDropDoneReceiver;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1030)
         {
            this.var_1030.release(new IIDAvatarRenderManager());
            this.var_1030 = null;
         }
         if(this.var_182)
         {
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1701);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_408.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_121.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_121.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_206.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_581.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2875 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_408.loadProductData(this);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1030 = param2 as IAvatarRenderManager;
      }
      
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._roomEngine = param2 as IRoomEngine;
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_150,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_182 != null && this.var_182.getKey("catalog.furniture.animation","QuestsList") == "HabboRoomUICom_pet_command")
         {
            if(this.var_711 == null)
            {
               this.var_711 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_182.getKey("toolbar.new_additions.notification.enabled","QuestsList") == "HabboRoomUICom_pet_command";
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_346.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_182.getKey("client.credits.embed.enabled","QuestsList") == "HabboRoomUICom_pet_command";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_408.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_408.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_408.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_887.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_121.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_121.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_121.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_121.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_121.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_121.clubPeriods));
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_346 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_712) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2018;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_74:
               this.var_2092 = param1.session.isPrivateRoom;
               this.var_1270 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1350 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_581 == null)
         {
            this.var_581 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1617 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_346.buildCatalogIndex(_loc2_);
         if(this.var_885 && this.var_885 != "")
         {
            this.var_346.openPage(this.var_885);
            this.var_885 = "";
            this.var_1093 = -1;
         }
         else if(this.var_1093 > -1)
         {
            this.var_346.openPageById(this.var_1093,this.var_2091);
            this.var_1093 = -1;
            this.var_2091 = -1;
            this.var_885 = "";
         }
         else if(this.var_1617 && this.var_2875)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_346.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1827));
         }
         else
         {
            this.var_346.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_121.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2876 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1220);
         }
         this.var_2876 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_73,this.var_121.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_121.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2873 && this._soundManager != null)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_121.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_121.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_121.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_121.isVIP = _loc2_.isVIP;
         this.var_121.pastClubDays = _loc2_.pastClubDays;
         this.var_121.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1350.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2874 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_887.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_887.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "HabboRoomUICom_pet_command" == this.var_182.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_182.keyExists("catalog.drag_and_drop") || this.var_182.getKey("catalog.drag_and_drop") != "HabboRoomUICom_pet_command")
         {
            return false;
         }
         if(!this.var_1270 || !this.var_1270.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1351 && param1.type == RoomEngineObjectEvent.const_150)
         {
            this.resetPlacedOfferData(true);
            if(this.var_886 == null || this.var_886.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_886.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_886);
            _loc5_ = this.var_1618;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_360,0.5);
            }
         }
      }
      ...
      public function method_3(param1:IWindow, param2:String, param3:Function) : void
      {
         if(!param2 || !assets)
         {
            return;
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_712);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_711 != null)
         {
            this.var_711.updatePreviewRoomView();
         }
      }
   }
}
