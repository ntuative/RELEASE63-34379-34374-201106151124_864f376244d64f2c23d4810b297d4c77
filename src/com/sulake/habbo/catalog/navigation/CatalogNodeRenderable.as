package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1641:XML;
      
      private static var var_1642:XML;
       
      
      private var var_2134:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2134 == 4294967295)
            {
               this.var_2134 = _loc1_.color;
            }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1965;
            }
         }
      }
      ...
      {
         this.var_64 = navigator.catalog.windowManager.buildFromXML(var_1642) as IItemListWindow;
         if(this.var_64 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1641) as IWindowContainer;
         }
         else
         {
