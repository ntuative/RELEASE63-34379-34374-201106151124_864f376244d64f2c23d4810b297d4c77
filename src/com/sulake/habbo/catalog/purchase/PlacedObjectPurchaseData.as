package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2081:IProductData;
      ...
      {
         this.var_1368 = param1.offerId;
         this.var_1887 = param1.productContainer.firstProduct.productClassId;
         this.var_2081 = param1.productContainer.firstProduct.productData;
         this.var_628 = param1.productContainer.firstProduct.furnitureData;
         this.var_1637 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_235,this._category,this.var_1888,this._x,this.var_185,this._direction,this.var_1368,this.var_1887].toString();
      }
