package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2017:uint = 4.293848814E9;
      
      private const const_2016:uint = 4.294967295E9;
      
      private const const_1562:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1368 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_375,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_319,this.onMessageInputFocus);
         }
         this.var_2117 = true;
         this.var_2116 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_551,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_2008 = _loc1_.stuffTypes;
            this.var_897 = _loc1_.boxTypes;
            this.var_896 = _loc1_.ribbonTypes;
            this.var_1369 = this.var_2008[0];
            this.var_414 = this.var_897[0];
            this.var_412 = this.var_896[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_412 < 0)
         {
            this.var_412 = this.var_896.length - 1;
         }
         if(this.var_412 > this.var_896.length - 1)
         {
            this.var_412 = 0;
         }
         if(this.var_414 < 0)
         {
            this.var_414 = this.var_897.length - 1;
         }
         if(this.var_414 > this.var_897.length - 1)
         {
            this.var_414 = 0;
         }
         var _loc1_:int = this.var_897[this.var_414] * 1000 + this.var_896[this.var_412];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1369,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1635 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2008)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1369);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_897[this.var_414]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_896[this.var_412]);
         this._catalog.purchaseProductAsGift(this.var_1636,this.var_1368,this.var_1637,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1636,this.var_1368,this.var_1637);
         this.dispose();
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_413 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_413 + 1);
               break;
      ...
      {
         if(this.var_299 == null || !this.var_299.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_299.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_413) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_299 == null)
         {
            this.var_299 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_898 == null)
         {
            this.var_898 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_299 == null || this.var_898 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_299.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_898.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_299.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_413) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_413);
         }
         this.var_413 = param1;
         if(this.var_413 < 0)
         {
            this.var_413 = _loc2_.numListItems - 1;
         }
         if(this.var_413 >= _loc2_.numListItems)
         {
            this.var_413 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_413) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1562;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2017) : uint(this.const_2016);
      }
      ...
      {
         this.var_1369 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1369;
               }
            }
            _loc4_++;
         }
