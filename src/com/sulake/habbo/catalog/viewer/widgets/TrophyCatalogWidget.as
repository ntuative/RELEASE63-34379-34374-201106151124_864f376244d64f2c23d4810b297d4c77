package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1611:int = 13421772;
      ...
      override public function init() : Boolean
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_287.getValue(_loc5_) == null)
            {
               this.var_287.add(_loc5_,new Map());
            }
            _loc7_ = this.var_287.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_287.getWithIndex(this.var_336);
         if(_loc4_ != null)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_287.getWithIndex(this.var_336);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_336;
         if(this.var_336 >= this.var_287.length)
         {
            this.var_336 = 0;
         }
         var _loc2_:Map = this.var_287.getWithIndex(this.var_336);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_336 < 0)
         {
            this.var_336 = this.var_287.length - 1;
         }
         var _loc2_:Map = this.var_287.getWithIndex(this.var_336);
         if(_loc2_ != null)
         {
