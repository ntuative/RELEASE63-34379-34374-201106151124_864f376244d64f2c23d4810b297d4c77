package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1613:int = 18;
      ...
      private var var_215:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_571 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_571 < 8)
         {
            return false;
         }
         ...
         if(this.var_215 != null && this.var_215.length > 0)
         {
            this.var_397 = this.var_215[0];
         }
         else
         {
            this.var_397 = -1;
         }
         this._offers.add(this.var_571,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_215 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1613 && _loc2_ < this.var_215.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_571,this.var_215[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_215 != null && this.var_215.length > 0)
         {
            ...
            this.var_397 = this.var_215[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_571,this.var_397),this.getRaceLocalizationKey(this.var_571,this.var_397));
            }
         }
         return this.getRaceLocalizationKey(this.var_571,this.var_397);
      }
