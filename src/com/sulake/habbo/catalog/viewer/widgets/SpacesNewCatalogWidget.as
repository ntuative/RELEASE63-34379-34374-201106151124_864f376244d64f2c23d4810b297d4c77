package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_115[this.var_593]);
      ...
      {
         var _loc2_:int = this.var_658[this.var_593];
         var _loc3_:Offer = this.var_232[this.var_593][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_500.numGridItems)
         {
            _loc2_ = this.var_232[this.var_593][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_658[this.var_593] = (this.var_232[this.var_593] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_658[0];
         var _loc2_:int = this.var_658[1];
         var _loc3_:int = this.var_658[2];
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_232[this.var_593],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_658[this.var_593];
