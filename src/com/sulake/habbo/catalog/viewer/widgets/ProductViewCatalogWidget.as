package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1766:Point;
      
      private var var_522:IItemGridWindow;
      
      private var var_1453:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_193 != null)
         {
            ...
            this.var_523 = this.var_193.findChildByName("room_canvas") as IDisplayObjectWrapper;
         ...
         this.var_1766 = new Point(this.var_97.x,this.var_97.y);
         this.var_522 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1453 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1176.y = this.var_956.y + this.var_956.height;
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_530:
                  ...
                  if(this.var_522 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_522,this.var_1453,this.var_2089);
               ...
               case Offer.const_442:
                  ...
                  if(this.var_193 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_70 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_180)
                     {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_323,AvatarAction.const_581);
                                 _loc18_.appendAction(AvatarAction.const_352,_loc9_.productClassId);
                                 _loc18_.endActionAppends();
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc18_.updateAnimationByFrames(1);
                                 _loc16_ = _loc18_.getImage(AvatarSetType.const_39,true);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_97 != null && true)
         {
            ...
            this.var_97.x = this.var_1766.x;
            this.var_97.y = this.var_1766.y;
            if(param3 != null)
            {
