package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_992:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_992.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_992 = null;
         }
         if(this.var_993 != null)
         {
            this.var_993.removeEventListener(WindowKeyboardEvent.const_193,this.windowKeyEventProcessor);
            this.var_993 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_992 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_992 != null)
         {
            this.var_992.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_993 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_993 != null)
         {
            this.var_993.addEventListener(WindowKeyboardEvent.const_193,this.windowKeyEventProcessor);
         }
         return true;
      }
