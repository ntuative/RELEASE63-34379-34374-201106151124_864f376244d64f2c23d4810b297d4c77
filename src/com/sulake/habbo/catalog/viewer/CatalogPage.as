package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1999:String = "ctlg_";
       
      
      protected var var_2213:XML;
      ...
      private var var_532:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_532 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1204);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1204);
      }
      ...
      {
         var _loc2_:String = const_1999 + param1;
         ...
         this.var_2213 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2213) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1868:
               if(this.var_1203 == null)
               {
                  this.var_1203 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1203);
               }
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.method_6();
         this.var_532.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_532 != null)
         {
            return this.var_532.dispatchEvent(param1);
         }
         return false;
      }
