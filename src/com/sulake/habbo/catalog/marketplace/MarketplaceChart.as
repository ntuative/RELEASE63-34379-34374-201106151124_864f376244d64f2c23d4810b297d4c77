package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1282,(param2 - this.var_1041) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1282 + this.var_1282 / -this.var_3036 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_1041 - this.var_1041 / this.var_674 * this.var_185[param1];
      }
