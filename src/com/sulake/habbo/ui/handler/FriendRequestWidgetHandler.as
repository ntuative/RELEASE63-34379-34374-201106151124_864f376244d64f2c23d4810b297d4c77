package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_742);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_978);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_918);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_742:
            ...
            case RoomWidgetFriendRequestMessage.const_978:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_918:
