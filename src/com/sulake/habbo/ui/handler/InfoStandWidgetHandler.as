   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_239 != null)
         {
            ...
            this.var_239.events.addEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            this.var_239.events.removeEventListener(SongInfoReceivedEvent.const_98,this.onSongInfoReceivedEvent);
            this.var_239 = null;
         }
         this.var_1126 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_592);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_935);
         _loc1_.push(RoomWidgetFurniActionMessage.const_307);
         _loc1_.push(RoomWidgetFurniActionMessage.const_969);
         _loc1_.push(RoomWidgetFurniActionMessage.const_751);
         _loc1_.push(RoomWidgetFurniActionMessage.const_869);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1216);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_746);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_830);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_893);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_722);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_283 || param1.type == RoomWidgetUserActionMessage.const_558 || param1.type == RoomWidgetUserActionMessage.const_485)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_592:
            ...
            case RoomWidgetUserActionMessage.const_651:
               ...
               break;
            case RoomWidgetUserActionMessage.const_935:
            ...
            case RoomWidgetUserActionMessage.const_485:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_969:
            ...
            case RoomWidgetFurniActionMessage.const_751:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_869:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1216:
            ...
            case RoomWidgetUserActionMessage.const_283:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_746:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_830:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_893:
            ...
            case RoomWidgetPetCommandMessage.const_901:
               ...
               this._container.roomSession.requestPetCommands(_loc15_.method_2);
               break;
            case RoomWidgetPetCommandMessage.const_497:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_722:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_316);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_412) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_412);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_928) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1369;
               }
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1244);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1287);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_397) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_397.length);
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_205)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_121)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_494)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_359);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_152)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_949);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_922;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_744;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1939);
               }
               else
               {
               ...
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_39,4);
                  _loc14_.image = _loc20_.getImage(AvatarSetType.const_39,true);
                  _loc20_.dispose();
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc3_:IUserData = this._container.roomSession.userDataManager.getPetUserData(_loc2_.method_2);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc5_,_loc6_,_loc3_.name,_loc2_.method_2,_loc7_,_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_949);
      ...
      private function onPetCommands(param1:RoomSessionPetCommandsUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            _loc2_ = new RoomWidgetPetCommandsUpdateEvent(param1.method_2,param1.allCommands,param1.enabledCommands);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc4_ != null)
            {
               _loc2_ = _loc4_.getCroppedImage(AvatarSetType.const_39);
               _loc4_.dispose();
            }
         }
         else
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_391,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_392,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
