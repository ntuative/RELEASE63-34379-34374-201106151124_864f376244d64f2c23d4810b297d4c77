package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1606:IMessageEvent;
      
      private var var_2079:IMessageEvent;
      
      private var var_2078:IMessageEvent;
      ...
      {
         this.var_1606 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2079 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2078 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1606);
         this._connection.addMessageEvent(this.var_2079);
         this._connection.addMessageEvent(this.var_2078);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1606);
               this._connection.removeMessageEvent(this.var_2079);
               this._connection.removeMessageEvent(this.var_2078);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_884,RoomWidgetPlayListModificationMessage.const_963,RoomWidgetPlayListModificationMessage.const_749,RoomWidgetPlayListPlayStateMessage.const_766,RoomWidgetPlayListUserActionMessage.const_945];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_884:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_934,_loc2_.id);
            ...
            case RoomWidgetPlayListModificationMessage.const_963:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_749:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_257);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_257:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_826,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_910,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_831));
               break;
