package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               ...
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_965,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_872,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_124,this.onHelpTutorialEvent);
            }
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_965,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_872,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_124,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1434)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc5_.setDirection(AvatarSetType.const_39,2);
               ...
               this.var_1727 = _loc1_;
               this.var_1728 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1727;
               _loc2_ = this.var_1728;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_464)
               {
                  ...
                  if(_loc2_.height > const_464 - const_1033)
                  {
                     _loc8_.offset(0,_loc2_.height - const_464 + const_1033);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_847);
         _loc1_.push(RoomWidgetDanceMessage.const_883);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_926);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_407);
         _loc1_.push(RoomWidgetStopEffectMessage.const_951);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1750);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1157);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_518);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1722);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1279);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_873);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_952);
         _loc1_.push(RoomWidgetMeMenuMessage.const_801);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_1000);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1958);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_983);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_786);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1232);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_403);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_952:
               ...
               break;
            case RoomWidgetWaveMessage.const_847:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_883:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_407:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1153)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_926:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1933:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1328:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1865:
                        this.var_13.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1804:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_951:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1157:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_873:
               ...
               break;
            case RoomWidgetMeMenuMessage.const_801:
            ...
            case RoomWidgetAvatarEditorMessage.const_518:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_1000:
            ...
            case RoomWidgetStoreSettingsMessage.const_983:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_434,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_786:
            ...
            case RoomWidgetAvatarEditorMessage.const_1232:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_489));
               }
               break;
            default:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_124:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_124));
               break;
            case HabboHelpTutorialEvent.const_872:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_587));
         }
      }
