package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_866,RoomWidgetViralFurniMessage.const_975,RoomWidgetViralFurniMessage.const_178];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_866:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_500);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_975:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_512,RoomSessionViralFurniStatusEvent.const_506];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionViralFurniStatusEvent.const_506:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_938);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
