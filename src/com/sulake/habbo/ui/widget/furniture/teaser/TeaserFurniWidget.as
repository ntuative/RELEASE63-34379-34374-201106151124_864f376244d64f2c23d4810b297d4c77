package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2025:int = 2;
      
      private const const_2028:int = 3;
      
      private const const_2022:int = 4;
      
      private const const_2296:int = 0;
      
      private const const_2291:int = 1;
      
      private const const_2289:int = 2;
      
      private const const_2293:int = 3;
      
      private const const_2292:int = 4;
      
      private const const_2290:int = 5;
      
      private const const_2026:String = "deco_img";
      
      private const const_2027:String = "dialog_bg";
      
      private const const_2297:String = "%campaign%_dialog_bg.png";
      
      private const const_380:String = "%campaign%_gift_package.png";
      
      private const const_2294:String = "%campaign%_gift_content.png";
      
      private const const_2295:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1490 = this.var_160.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1490 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1487.length)
         {
            _loc2_ = this.var_1487.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_160 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_500,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_807,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_938,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_500,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_500:
               _loc2_ = this.const_2024;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_938:
               ...
               if(_loc5_)
               {
                  ...
                  {
                     _loc2_ = this.const_2025;
                  }
               }
               else
               {
                  _loc2_ = this.const_2022;
               }
               this._shareId = null;
         ...
         if(this._window && (this.var_1488 != _loc2_ || _loc3_ != this.var_194))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1488)
            {
               ...
               case this.const_2023:
                  if(this.var_425 == this.const_2296)
                  {
                  ...
                  else if(this.var_425 == this.const_2291)
                  {
                     ...
                     _loc2_ = this.const_2294;
                  }
                  else if(this.var_425 == this.const_2289)
                  {
                  ...
                  else if(this.var_425 == this.const_2292)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_194,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_425 == this.const_2290)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2297.replace("%campaign%",this.var_194);
            this.setDecoImage(_loc5_,this.const_2027);
            _loc2_ = _loc2_.replace("%campaign%",this.var_194);
            this.setDecoImage(_loc2_,this.const_2026);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_975);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1489 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1489 == 1 ? "null" : InventoryCategory.const_137);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_779,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1487.push(new ImageDownloader(this,_assets,this.var_194,this.var_1490,param1,param2));
            return;
         }
