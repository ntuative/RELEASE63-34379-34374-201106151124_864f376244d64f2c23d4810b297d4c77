   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in this.colors)
         {
            ...
            _loc3_.width = this.var_616.width;
            _loc3_.height = this.var_616.height;
            this.var_519.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_616.width,this.var_616.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_616,this.var_616.rect,new Point(0,0));
            }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_616 = BitmapData(_loc3_.content);
