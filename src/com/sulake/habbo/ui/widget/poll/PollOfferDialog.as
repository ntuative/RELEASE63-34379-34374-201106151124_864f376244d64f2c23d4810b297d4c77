package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1963:String = "POLL_OFFER_STATE_OK";
      
      public static const const_982:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_117:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_117)
         {
            return;
         }
         this._state = const_1963;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_921,this._id));
      }
