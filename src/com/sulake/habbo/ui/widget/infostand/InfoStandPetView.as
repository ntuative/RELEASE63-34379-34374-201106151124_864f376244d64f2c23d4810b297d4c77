package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1470:int = 152;
      
      private static const const_1478:int = 16;
      
      private static const const_684:int = 4;
      
      private static const const_1476:uint = 14342874;
      
      private static const const_1474:uint = 3815994;
      
      private static const const_1467:uint = 2085362;
      
      private static const const_1477:uint = 39616;
      
      private static const const_1473:uint = 10513106;
      
      private static const const_1465:uint = 8734654;
      
      private static const const_1468:uint = 9094430;
      
      private static const const_1469:uint = 6200576;
      
      private static const const_1475:String = "happiness";
      
      private static const const_1471:String = "experience";
      
      private static const const_1472:String = "energy";
      
      private static const const_1466:int = 250;
      
      private static const const_1056:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1475,param1.nutrition,param1.nutritionMax,const_1477,const_1467);
         this.updateStateElement(const_1471,param1.experience,param1.experienceMax,const_1465,const_1473);
         this.updateStateElement(const_1472,param1.energy,param1.energyMax,const_1469,const_1468);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1470,const_1478,false);
         ...
         _loc7_.fillRect(_loc8_,const_1474);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_218 && this.var_218.getPetId() == this.var_510)
               {
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1056 + const_1057;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1057;
            }
         }
         this.var_108.height = _loc4_ + const_1056;
         this.updateWindow();
      }
   }
}
