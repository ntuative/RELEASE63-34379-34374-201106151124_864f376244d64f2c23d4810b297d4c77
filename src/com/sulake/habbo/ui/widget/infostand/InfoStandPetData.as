package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1937 = param1.id;
         this._type = param1.petType;
         this.var_2262 = param1.petRace;
         this.var_47 = param1.image;
         this.var_2743 = param1.isOwnPet;
         this.var_2484 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1305 = param1.level;
         this.var_2516 = param1.levelMax;
         this.var_2519 = param1.experience;
         this.var_2517 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2518 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2520 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2244 = param1.roomIndex;
         this.var_577 = param1.age;
      }
   }
}
