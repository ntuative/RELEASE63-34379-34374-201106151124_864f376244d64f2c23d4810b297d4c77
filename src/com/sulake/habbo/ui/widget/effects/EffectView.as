package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2284:int = 1000;
      ...
      private var var_518:ITextWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_124 = param2;
         this._widget = param1;
         this.var_226 = new Timer(this.const_2284);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_124.isActive)
         {
            ...
            this.var_615.width = _loc2_ * this.var_344;
         }
         else
         {
            this.var_615.width = 0;
            this.var_226.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_518 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_518 == null)
            {
               return;
            }
         ...
         if(!this.var_124.isActive)
         {
            this.var_518.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_518.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_518.text;
      ...
      public function update() : void
      {
         ...
         this.setTimeLeft();
         this.var_615 = this._window.findChildByName("loader_bar");
         if(this.var_615 != null)
         {
            this.var_344 = this.var_615.width;
            this.var_226.start();
            this.onUpdate();
         }
