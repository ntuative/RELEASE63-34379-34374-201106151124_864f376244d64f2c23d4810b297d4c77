package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectsWidget extends RoomWidgetBase
   {
      ...
      private static const const_1653:int = 320;
      
      private static const const_1651:int = 48;
      ...
      {
         return var_1127 as EffectsWidgetHandler;
      }
      ...
      public function open() : void
      {
         ...
         if(!this._view)
         {
            ...
            this._view.x = _loc2_.right + const_1652;
      ...
      public function update() : void
      {
         ...
         {
            _loc1_ = this.var_713.getValue(_loc3_.type) as EffectView;
            if(_loc1_)
            {
               _loc1_.update();
            }
            else
            {
               ...
               this.var_713.add(_loc3_.type,_loc1_);
         ...
         this.var_64.height = Math.max(Math.min(_loc4_,const_1653),const_1651);
      ...
      {
         this.handler.container.catalog.openCatalogPage(CatalogPageName.const_1260,true);
      }
   }
}
