package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1347:String = "PLSV_START_PLAYBACK";
      
      public static const const_601:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_601)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_483[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_483[const_931];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_601,_loc1_);
