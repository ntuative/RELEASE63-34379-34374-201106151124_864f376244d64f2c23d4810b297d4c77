package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_996:String = "MISV_BUY_MORE";
      
      public static const const_867:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1855:ITextWindow;
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1855.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_867,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_996,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_867,_loc1_);
            this.var_1854 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1855 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_483.add(const_996,_loc1_);
