package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_292:int = 0;
      
      public static const const_93:int = 39;
      ...
      private var var_2935:BitmapData;
      
      private var var_2122:BitmapData;
      
      private var var_2937:BitmapData;
      
      private var var_2123:BitmapData;
      
      private var var_2124:BitmapData;
      
      private var var_2938:BitmapData;
      
      private var var_2934:BitmapData;
      
      private var var_2939:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2935 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_2122 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2937 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_2123 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_2124 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2938 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2934 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_88 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_331,HabboWindowStyle.const_31,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_93),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_88);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_77,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_43.height - const_93,param3.width,const_93),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_343,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_93),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_621:
               this.var_88.blend += param1 / const_1137;
               ...
               break;
            case const_1037:
               this.var_88.blend -= param1 / const_1136;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_422:
               if(this._state == const_292)
               {
                  this.state = const_621;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_43.height - const_93;
            this._window.width = this.var_43.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_43.height - const_93;
            this._region.width = this.var_43.width - this.var_2939;
         }
         if(this.var_88 != null)
         {
            this.var_88.rectangle = this.var_43.rectangle;
            this.var_88.height -= const_93;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2936 == this._window.width)
         {
            return;
         }
         this.var_2936 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2937;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_2123;
            barX.disposesBitmap = false;
            this.var_2939 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2935,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2122,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2122,destGripRBitmap);
         ...
         this.var_88.bitmap = this.var_2934;
