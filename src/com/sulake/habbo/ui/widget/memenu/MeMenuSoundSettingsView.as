package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_937 = param1.volume;
         if(this.var_934 != null)
         {
            this.var_934.setValue(this.var_937);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_938 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_933 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_1000));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_937 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_933);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_938);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_936);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_935);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_786);
         }
