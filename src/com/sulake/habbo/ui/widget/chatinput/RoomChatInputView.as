package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1514:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1239 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2614 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2613 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_382 = new Timer(1000,1);
         this.var_382.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_458 = new Timer(10000,1);
         this.var_458.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_458.reset();
            this.var_458.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_458 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1891 = this._window.findChildByName("send_button_text");
         this.var_1520 = this._window.findChildByName("block_text");
         this.var_1891.caption = const_1514;
         ...
         this.var_27.addEventListener(WindowKeyboardEvent.const_193,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_375,this.keyUpHandler);
         ...
         this.var_1522 = true;
         this.var_647 = "";
         this._window.addEventListener(WindowEvent.const_800,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_660,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1516 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1515);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1239 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_647 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_647.length + 1)
            {
