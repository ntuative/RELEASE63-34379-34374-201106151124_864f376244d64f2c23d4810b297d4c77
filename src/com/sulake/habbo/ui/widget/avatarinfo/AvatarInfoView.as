package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1394:uint = 4283715916;
      
      protected static const const_1396:uint = 16777215;
      ...
      private static const const_1627:int = 25;
      ...
      protected var var_2244:int;
      
      protected var var_1402:Boolean;
      
      protected var var_2230:FixedSizeStack;
      
      protected var var_2231:int = -1000000;
      
      protected var _disposed:Boolean;
      
      protected var var_504:Timer;
      
      protected var var_3008:int = 3000;
      ...
      {
         this.var_2230 = new FixedSizeStack(const_1627);
         super();
         this._widget = param1;
         this.var_1131 = true;
         this.var_1680 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1682 = param5;
         param1.var_2244 = param4;
         param1.var_2229 = param6;
         param1.var_1680 = false;
         param1.var_3007 = 500;
         param1.var_1681 = false;
         param1._blend = 1;
         if(param1.var_1131)
         {
            if(!param1.var_504)
            {
               param1.var_504 = new Timer(param1.var_3008,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_628));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1681)
         {
            ...
            this._blend = 1 - this.var_1679 / Number(this.var_3007);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1402)
         {
            ...
            if(this.var_1682 == RoomObjectTypeEnum.const_121 || this.var_1682 == RoomObjectTypeEnum.const_494)
            {
            ...
            this.var_2230.addValue(_loc5_);
            _loc6_ = this.var_2230.getMax();
            if(_loc6_ < this.var_2231 - const_1121)
            {
               _loc6_ = this.var_2231 - const_1121;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2231 = _loc6_;
