package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1084:String = "use_minimized_own_avatar_menu";
      ...
      private var var_244:AvatarInfoData;
      ...
      private var var_820:AvatarInfoView;
      
      private var var_819:OwnAvatarMenuView;
      
      private var var_818:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_23 = param6;
         this.var_182 = param4;
         this.var_244 = new AvatarInfoData();
         this.var_2649 = Boolean(this.var_182.getBoolean("menu.avatar.enabled",false));
         this.var_1911 = this.var_182.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_445,this.onRoomObjectRemoved);
      ...
      {
         return var_1127 as AvatarInfoWidgetHandler;
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_753,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_445,this.onRoomObjectRemoved);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_316,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_641,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_793,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_316,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_641,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_133:
               ...
               if(this.var_1911 && _loc2_.allowNameChange)
               {
               ...
               {
                  this.updateView(_loc2_.userId,_loc2_.userName,_loc2_.roomIndex,RoomObjectTypeEnum.const_121,_loc2_.allowNameChange,null);
               }
               this._isInitialized = true;
               break;
            case RoomWidgetRoomObjectNameEvent.const_641:
               if(RoomWidgetRoomObjectNameEvent(param1).category == RoomObjectCategoryEnum.const_29)
               {
                  this.updateView(RoomWidgetRoomObjectNameEvent(param1).userId,RoomWidgetRoomObjectNameEvent(param1).userName,RoomWidgetRoomObjectNameEvent(param1).roomIndex,RoomObjectTypeEnum.const_121,false,null);
               }
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_316:
               if(this._view)
               {
                  this.removeView(this._view,false);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_793:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1914 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_881,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            ...
            case RoomWidgetUserInfoUpdateEvent.const_152:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_121,false,!!_loc3_.isSpectatorMode ? null : this.var_244);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_494,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.const_113:
               if(this.var_1912)
               {
                  _loc6_ = param1 as RoomWidgetPetInfoUpdateEvent;
                  this.updateView(_loc6_.id,_loc6_.name,_loc6_.roomIndex,RoomObjectTypeEnum.const_205,false,null);
               }
               break;
      ...
      {
         this.var_244.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_244.amIController = param1.amIController;
         this.var_244.amIOwner = param1.amIOwner;
         this.var_244.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_244.canBeKicked = param1.canBeKicked;
         this.var_244.canTrade = param1.canTrade;
         this.var_244.canTradeReason = param1.canTradeReason;
         this.var_244.hasFlatControl = param1.hasFlatControl;
         this.var_244.isIgnored = param1.isIgnored;
         this.var_244.respectLeft = param1.respectLeft;
         this.var_244.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_110;
         this.var_244.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1911) : Boolean(this.var_2649);
         }
            ...
            if(!this.var_1913)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_819)
                     {
                        this.var_819 = new OwnAvatarMenuView(this);
                     }
                     this._view = this.var_819;
                  ...
                  else
                  {
                     if(!this.var_818)
                     {
                        this.var_818 = new AvatarMenuView(this);
                     }
                     this._view = this.var_818;
               ...
               else
               {
                  if(!this.var_820)
                  {
                     this.var_820 = new AvatarInfoView(this);
                  }
      ...
      private function showFriendName(param1:IUserData, param2:int) : void
      {
         ...
         if(this.var_384[param1.name] == null)
         {
            ...
            FriendNameView.setup(_loc3_,param1.webID,param1.name,-1,RoomObjectTypeEnum.const_121,param2);
      ...
      {
         return this.handler.container.config.getBoolean(const_1084,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1084,!!param1 ? "1" : "0");
      }
   }
}
