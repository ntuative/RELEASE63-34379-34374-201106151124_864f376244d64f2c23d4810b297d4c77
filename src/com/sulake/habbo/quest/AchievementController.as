package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1594:int = 8;
      
      private static const const_1592:int = 5;
      
      private static const const_1596:int = 6;
      ...
      private static const const_1593:int = 180;
      
      private static const const_1601:int = 246;
      
      private static const const_1414:int = 45;
      
      private static const const_1597:Point = new Point(115,93);
      
      private static const const_1599:Point = new Point(72,1);
      
      private static const const_1104:int = 40;
      
      private static const const_1100:int = 20;
      
      private static const const_1595:int = 3;
      ...
      private var var_845:ProgressBar;
      
      private var var_1280:Matrix;
      
      private var var_1981:ColorMatrixFilter;
      
      private var var_1567:AchievementData;
      
      private var var_844:Timer;
      
      private var var_672:Dictionary;
      
      private var var_843:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_844 = new Timer(2000,1);
         this.var_844.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_843 = new AchievementLevelUp(this._questEngine);
         this.var_1280 = new Matrix();
         this.var_1981 = this.createGrayscaleFilter();
         this.var_672[16] = 1;
         this.var_672[28] = 6;
         this.var_672[38] = 4;
         this.var_672[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_844)
         {
            this.var_844.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_844.reset();
            this.var_844 = null;
         }
         if(this.var_673)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1414;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_467.height = getLowestPoint(this.var_467);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_845.refresh(this.var_115.getProgress(),this.var_115.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_846.height = getLowestPoint(this.var_846);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_1039.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category.code);
         ...
         this._questEngine.setupAchievementCategoryImage(this.var_1039,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_466.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getBadgeName(_loc1_);
         var _loc2_:String = this._questEngine.localization.getBadgeDesc(_loc1_);
         this.var_466.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this._questEngine.refreshReward(!this.var_75.finalLevel,this.var_466,this.var_75.levelRewardPointType,this.var_75.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_466,this.var_75);
         this.var_673.refresh(this.var_75.currentPoints,this.var_75.scoreLimit,this.var_75.type * 10000 + this.var_75.level);
         this.var_673.visible = !this.var_75.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1100;
         this.var_467 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1039 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_846 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_466 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1568 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1281 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_673 = new ProgressBar(this._questEngine,this.var_466,const_1593,"achievements.details.progress",true,const_1597);
         this.var_845 = new ProgressBar(this._questEngine,this.var_1281,const_1601,"achievements.categories.totalprogress",true,const_1599);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_467.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_701);
         var _loc5_:* = _loc4_ < const_1598;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1594) * (param1 % const_701);
            _loc3_.y = (_loc3_.height + const_1592) * Math.floor(param1 / const_701) + const_1596;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_846.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1105);
         var _loc5_:* = _loc4_ < const_1591;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.y = _loc3_.height * _loc4_ + const_1595;
      ...
      private function onSelectCategory(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this._category = this.var_115.categoryList[_loc3_];
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_467.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_467.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_842[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_842[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1104 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1600) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1981);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         this.var_1280.identity();
         this.var_1280.scale(2,2);
         this.var_1280.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1280);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1981);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_75 = this.var_1567;
         this.var_115.update(this.var_1567);
         this.var_1567 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_842[param1.badgeId] = param1.badgeImage;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_845.updateView();
         }
         if(this.var_843 != null)
         {
            this.var_843.update(param1);
         }
      }
      ...
      {
         return !!this.var_672[param1] ? int(this.var_672[param1]) : 0;
      }
