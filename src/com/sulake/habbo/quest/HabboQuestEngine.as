package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1407:int = 300;
      ...
      private var var_1142:QuestController;
      
      private var var_926:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1142 = new QuestController(this);
         this.var_926 = new AchievementController(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_408.events.removeEventListener(BadgeImageReadyEvent.const_214,this.var_926.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_408.events.addEventListener(BadgeImageReadyEvent.const_214,this.var_926.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1142.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_926.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1142.questTracker.isVisible();
      }
      ...
      {
         this.var_1142.update(param1);
         this.var_926.update(param1);
      }
