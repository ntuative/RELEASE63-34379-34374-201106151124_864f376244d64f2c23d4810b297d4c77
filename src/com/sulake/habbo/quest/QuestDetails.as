package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1414:int = 56;
      
      private static const const_676:int = 5;
      
      private static const const_1413:int = 5;
      
      private static const const_1031:Point = new Point(8,8);
      
      private static const const_1415:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_125 == null || this.var_125.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc10_.x = const_1031.x;
            _loc10_.y = const_1031.y;
         ...
         var _loc2_:* = this.var_125.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1413;
         }
         ...
         var _loc7_:Boolean = const_1415.indexOf(param1.type) > -1 && !_loc2_;
         ...
         this._window.height = _loc10_.height + const_1414;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1421 = NextQuestTimer.const_823;
         var _loc2_:Boolean = this._questEngine.questController.questsList.refreshDelay(this._window,this.var_125);
         if(_loc2_)
         {
            this.openDetails(this.var_125);
         }
      }
   }
}
