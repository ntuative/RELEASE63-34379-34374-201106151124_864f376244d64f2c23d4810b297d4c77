package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1971:int = 16777215;
      
      public static const const_1812:int = 13421772;
      
      private static const const_1066:int = 16777215;
      
      private static const const_1064:int = 13421772;
      
      private static const const_1065:int = 10066329;
      
      private static const const_1063:int = 10066329;
      
      public static const const_1946:int = 16777215;
      
      public static const const_1725:int = 13421772;
      
      public static const const_1786:int = 10066329;
      ...
      private var var_793:Rectangle = null;
      
      private var var_539:RoomPlaneBitmapMaskParser = null;
      
      private var var_1517:String = null;
      
      private var _floorType:String = null;
      
      private var var_1518:String = null;
      ...
      private var var_2041:int = -1000;
      
      private const const_2298:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_539 = new RoomPlaneBitmapMaskParser();
         this.var_324["null"] = false;
         this.var_324["null"] = true;
         this.var_324["null"] = true;
         this.var_324["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_149 != null)
         {
            ...
            {
               _loc2_ = this.var_149[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_793 = super.boundingRectangle;
         }
         return new Rectangle(this.var_793.x,this.var_793.y,this.var_793.width,this.var_793.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_149.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_149[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1267);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1289);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_310)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1978)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_79,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_2041 + this.const_2298 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_375.length)
            {
               _loc11_ = this.var_635[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_375[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1861)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2503 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2504 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2502 / 255);
         ...
         var_162 = _loc7_.getUpdateID();
         this.var_2041 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1711)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1526 || _loc3_.y != this.var_2501 || _loc3_.z != this.var_2505 || param1.scale != this.var_1863))
            {
               this.var_1526 = _loc3_.x;
               this.var_2501 = _loc3_.y;
               this.var_2505 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_162 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_1862)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1862 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1005));
            if(_loc4_ != this.var_1224)
            {
               this.var_1224 = _loc4_;
               this.var_2503 = this.var_1224 & 255;
               this.var_2504 = this.var_1224 >> 8 & 255;
               this.var_2502 = this.var_1224 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1372));
            if(_loc5_ != this.var_1861)
            {
               this.var_1861 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_162 != param1.getUpdateID())
         {
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_905));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_829));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_162 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1165);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1249);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1492))
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_149[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_324["null"] || param2 != this.var_324["null"] || param3 != this.var_324["null"])
         {
            this.var_324["null"] = param1;
            this.var_324["null"] = param2;
            this.var_324["null"] = param3;
            this.var_375 = [];
            this.var_635 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_375;
         if(this.var_375.length == 0)
         {
            _loc6_ = this.var_149;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_375.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_324[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1223;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_539.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_149.length)
         {
            _loc3_ = this.var_149[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_539.maskCount)
         {
            _loc10_ = this.var_539.getMaskType(_loc8_);
            _loc11_ = this.var_539.getMaskLocation(_loc8_);
            _loc12_ = this.var_539.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_149.length)
               {
                  _loc3_ = this.var_149[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_79 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_242)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_149[_loc18_] as RoomPlane;
