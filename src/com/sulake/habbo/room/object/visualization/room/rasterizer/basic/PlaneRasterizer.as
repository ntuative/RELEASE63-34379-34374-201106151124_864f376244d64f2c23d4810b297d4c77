   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_149 != null)
         {
            ...
            {
               _loc2_ = this.var_149.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_705.length)
            {
               _loc3_ = this.var_705.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_149.getValue(param1) == null)
         {
            this.var_149.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_705.getValue(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            this.var_705.add(_loc4_,_loc5_);
         }
         return _loc5_;
      }
