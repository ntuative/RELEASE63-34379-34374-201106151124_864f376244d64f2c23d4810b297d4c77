package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_985:IPlaneRasterizer = null;
      ...
      private var var_445:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2522 = param10;
         this.var_2526 = param11;
      ...
      {
         return this._isVisible && this.var_795;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_985.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_445;
         if(_loc3_ == null)
         {
         ...
         if(this.var_795 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_376))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_985 != null)
            {
               _loc3_ = this.var_985.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1867,this.var_2524,this.var_2522,this.var_2526,this.var_2521,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_795)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1496.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1496[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_171.z - originZ,this.var_127.z - originZ,this.var_99.z - originZ,this.var_128.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2525 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2523);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_986)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_377.length)
            {
               _loc5_ = this.var_377[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_276.length == this.var_984.length)
         {
            while(_loc1_ < this.var_276.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_984[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_377.length > this.var_1495.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_986 || this.var_276.length == 0 && this.var_377.length == 0 && !this.var_376 || this.var_748 == null)
         {
            return;
         }
         ...
         if(this.var_376)
         {
            ...
            while(_loc5_ < this.var_276.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_78.width - this.var_78.width * _loc3_.leftSideLoc / this.var_330.length;
                  _loc11_ = this.var_78.height - this.var_78.height * _loc3_.rightSideLoc / this.var_329.length;
                  _loc12_ = _loc3_.type;
                  this.var_748.updateMask(this.var_78,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_984.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_377.length)
            {
               _loc4_ = this.var_377[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_78.width - this.var_78.width * _loc4_.leftSideLoc / this.var_330.length;
                  _loc11_ = this.var_78.height - this.var_78.height * _loc4_.rightSideLoc / this.var_329.length;
                  _loc13_ = this.var_78.width * _loc4_.leftSideLength / this.var_330.length;
                  _loc14_ = this.var_78.height * _loc4_.rightSideLength / this.var_329.length;
                  this.var_78.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1495.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_376 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_241 != null && (this.var_241.width != param1.width || this.var_241.height != param1.height))
         {
            this.var_241.dispose();
            this.var_241 = null;
         }
         if(this.var_241 == null)
         {
            this.var_241 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_241.copyChannel(param1,param1.rect,const_685,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_241.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_241,this.var_241.rect,const_685,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
