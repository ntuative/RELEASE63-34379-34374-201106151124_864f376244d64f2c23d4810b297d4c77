package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_456:int = 1000;
      ...
      private var var_1648:int = 360;
      
      private var var_901:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_901 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_300 != null)
         {
            ...
            {
               _loc2_ = this.var_300.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_901,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_300.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_901);
            this.defineDirection(_loc3_,_loc8_);
            this.var_300.add(String(_loc7_),_loc3_);
            this.var_2143 = -1;
            this.var_1376 = null;
            _loc5_++;
         }
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1648 / 2) % 360 / this.var_1648;
         if(this.var_300.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_300.length)
         {
            _loc6_ = int(this.var_300.getKey(_loc5_)) * this.var_1648;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_300.getKey(_loc4_));
         }
         return const_1888;
      }
      ...
      {
         if(param1 == this.var_2143)
         {
            return this.var_1376;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_300.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_901;
         }
