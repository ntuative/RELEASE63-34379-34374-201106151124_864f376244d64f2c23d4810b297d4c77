package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1558:String = "pet_experience_bubble_png";
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1036 = [];
         super();
         while(this.var_131.length < ANIMATION_INDEX_COUNT)
         {
            this.var_131.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_131 != null)
         {
            ...
            {
               _loc2_ = this.var_131[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1558) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_388 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_162)
         {
            ...
            this.var_1918 = _loc3_.getNumber(RoomObjectVariableEnum.const_252) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_212);
            if(!isNaN(_loc8_))
            {
               this.var_1974 = _loc8_;
            }
            else
            {
               this.var_1974 = direction;
            }
            this.var_1561 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2519 = _loc3_.getNumber(RoomObjectVariableEnum.const_430);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_887);
            if(_loc9_ != this.var_1973)
            {
               this.var_1973 = _loc9_;
               this.var_2716 = this.var_1973.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_388 != null)
         {
            ...
            if(this.var_1561 > 0)
            {
               _loc2_ = param1 - this.var_1561;
               if(_loc2_ < const_1099)
               {
                  this.var_388.alpha = int(Math.sin(_loc2_ / const_1099 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_388.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_388.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_282)
         {
            ...
            this.setAnimationForIndex(const_1555,_loc3_);
         }
         if(param2 != this.var_1542)
         {
            this.var_1542 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_101,param2);
            this.setAnimationForIndex(const_1556,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_697;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1560 = false;
         var _loc1_:int = this.var_131.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_131[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_131.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_131[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_131.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_131[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2716);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_697)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_697))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1974);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_101,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1557)
            {
               this.var_1036[param1] = true;
            }
            else
            {
               this.var_1036[param1] = false;
            }
         }
