package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1492:String = "branded_image";
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1674 = _loc4_.getNumber(RoomObjectVariableEnum.const_567);
                  this.var_1673 = _loc4_.getNumber(RoomObjectVariableEnum.const_664);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_613);
               }
            }
         }
         if(!this.var_1394)
         {
            this.var_1394 = this.checkIfImageReady();
            if(this.var_1394)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_502);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1492)
         {
