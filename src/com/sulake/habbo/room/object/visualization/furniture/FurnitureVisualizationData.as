package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_1076:SizeData = null;
      
      private var var_2055:int = -1;
      
      private var var_2452:int = -1;
      
      private var var_2835:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_341 != null)
         {
            ...
            {
               _loc1_ = this.var_341.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_341.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_341.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_1076 = this.var_341.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_1076 = null;
