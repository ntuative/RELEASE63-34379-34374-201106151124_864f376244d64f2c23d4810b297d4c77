package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1462:String = "shore";
      ...
      {
         if(this.var_2421 == param1 && this.var_2422 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1462)
            {
               this.var_1813 = _loc2_;
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_530 + 2;
         var _loc4_:int = this.var_624 + 2;
         var _loc5_:int = 0;
      ...
      {
         var _loc2_:* = null;
         if(this.var_530 == 0 || this.var_624 == 0)
         {
            ...
            this.var_530 = _loc2_.getNumber(RoomObjectVariableEnum.const_371);
            this.var_624 = _loc2_.getNumber(RoomObjectVariableEnum.const_428);
         }
         this.var_440 = [];
         this.var_625 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_530 * 2 + this.var_624 * 2)
         {
            this.var_440.push(false);
            this.var_625.push(ShoreMaskCreatorUtility.const_85);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_530 + 2;
         var _loc2_:int = this.var_624 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_78,getSize(param3),this.var_440,this.var_625,assetCollection);
      }
