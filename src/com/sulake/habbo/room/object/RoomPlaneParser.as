   ...
   public class RoomPlaneParser
   {
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_269 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_495 || param1 == this.var_492)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_494;
               ...
               if(param2 == this.var_494 || param2 == this.var_493)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_495;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc2_ < this._height)
         {
            ...
            {
               this.var_728[_loc2_][_loc8_] = this.var_140[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         ...
         this.var_927 = getFloorHeight(this.var_140);
         if(!param1)
         {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc8_:Number = const_1234 * this.var_1492;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         var _loc14_:RoomPlaneData = this.addPlane(RoomPlaneData.const_310,param1,param2,param3);
         ...
         if(_loc14_)
         {
            ...
            if(param6)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_310,_loc15_,new Vector3d(0,0,-_loc20_),param2);
               if(_loc16_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc16_ = this.addPlane(RoomPlaneData.const_310,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param2,-1));
               if(_loc16_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_310,_loc15_,new Vector3d(0,0,-_loc20_),Vector3d.product(param3,-1));
               if(_loc17_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc17_ = this.addPlane(RoomPlaneData.const_310,_loc15_,new Vector3d(0,0,-_loc20_),param3);
               if(_loc17_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_269}" height="{this._height}" wallHeight="{this.var_1654}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc5_ = <tileRow/>;
            _loc6_ = this.var_728[_loc2_];
            _loc7_ = 0;
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_149[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_149[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
