package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1474:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_666,RoomObjectMouseEvent.const_142];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1267,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1005,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_990,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_905,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1210)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1827;
            if(_loc2_ - this.var_1210 >= this.var_1828)
            {
            ...
            {
               _loc7_ = this.var_1474 >> 16 & 255;
               _loc8_ = this.var_1474 >> 8 & 255;
               _loc9_ = this.var_1474 & 255;
               _loc10_ = this.var_1211 >> 16 & 255;
               _loc11_ = this.var_1211 >> 8 & 255;
               _loc12_ = this.var_1211 & 255;
               _loc13_ = (_loc2_ - this.var_1210) / this.var_1828;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1005,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_799:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_974:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_525:
               ...
               this.var_539.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_777:
               _loc4_ = this.var_539.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_539.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1208:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1349:
               param2.setNumber(RoomObjectVariableEnum.const_905,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1234:
               param2.setNumber(RoomObjectVariableEnum.const_1249,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1372,int(param1.bgOnly));
         this.var_1474 = this._color;
         this.var_1826 = this.var_1827;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1907,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1780,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1984,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_272 || _loc12_ == RoomPlaneData.const_444)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
