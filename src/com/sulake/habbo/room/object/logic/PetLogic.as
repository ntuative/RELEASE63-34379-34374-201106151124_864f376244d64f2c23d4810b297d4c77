package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_142,RoomObjectMoveEvent.const_433];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2628)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1465 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_252,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_430,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1910,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_887,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_212,_loc3_ + this.var_1012);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1905;
            _loc2_.setNumber(RoomObjectVariableEnum.const_277,this.var_1905);
            _loc2_.setNumber(RoomObjectVariableEnum.const_173,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1906;
            _loc2_.setNumber(RoomObjectVariableEnum.const_173,this.var_1906);
         }
         else
         {
            this.var_1012 += 45;
