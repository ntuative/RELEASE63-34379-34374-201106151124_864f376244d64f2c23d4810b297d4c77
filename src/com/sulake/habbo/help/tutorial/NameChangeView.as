package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_882)
         {
            this.var_882 = this.var_28.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_882)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_883)
         {
            this.var_883 = this.var_28.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_883)
            {
               return;
            }
