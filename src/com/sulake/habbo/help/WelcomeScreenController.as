   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_195)
         {
            ...
            this.var_195.toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this.var_195 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_70 = param1;
         this.var_195.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         ...
         this.var_227.y = this.var_195.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
