package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_792:HotelMergeUI;
      
      private var var_1484:CallForHelpData;
      
      private var var_2481:UserRegistry;
      ...
      {
         this.var_1484 = new CallForHelpData();
         this.var_2481 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1217 = new FaqIndex();
      ...
      {
         this.var_1484.reportedUserId = param1;
         this.var_1484.reportedUserName = param2;
         this.var_73.showUI(HabboHelpViewEnum.const_405);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_792)
         {
            this.var_792 = new HotelMergeUI(this);
         }
         this.var_792.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_117)
         {
            this.var_117.showView(TutorialUI.const_334);
         }
      }
