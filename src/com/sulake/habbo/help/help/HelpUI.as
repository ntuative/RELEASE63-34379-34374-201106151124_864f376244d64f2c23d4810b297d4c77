package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2152:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106151119));
         this.var_139 = new Map();
         this.var_139.add(HabboHelpViewEnum.const_1840,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_227,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_630,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_374,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_246,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_405,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_959,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_249,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_139.add(HabboHelpViewEnum.const_1159,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_139.add(HabboHelpViewEnum.const_1319,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_754,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2152)
         {
            this.var_590 = new Array();
         }
         else if(param2)
         {
            if(this.var_590.length == 0 || param1 != this.var_418)
            {
               this.var_590.push(this.var_418);
            }
         }
         this.var_418 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_418);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_249:
               ...
               break;
            case CallForHelpResultEnum.const_1298:
               this.showUI(HabboHelpViewEnum.const_1319);
               break;
            case CallForHelpResultEnum.const_1286:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_139.getValue(HabboHelpViewEnum.const_227) as IHelpViewController;
      ...
      {
         return this.var_139.getValue(this.var_418);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2626 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2625;
         this._window.width = _loc1_.width + this.var_2626;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_590.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_418 == HabboHelpViewEnum.const_227)
         {
            return;
         }
         if(this.var_727.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_727.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_727.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_417.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_727[1],this.var_727[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_727[0],this.var_727[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_418 == HabboHelpViewEnum.const_227 || this.var_590.length == 0)
         {
            return;
         }
         if(this.var_417 == null)
         {
            ...
            this.var_417 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_417.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_417.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_417 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_417 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_417 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
