package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_863:ISessionDataManager;
      
      private var var_2774:FriendListLookAndFeel;
      
      private var var_476:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2010:OpenedToWebPopup;
      
      private var var_2311:int;
      
      var var_115:FriendCategories;
      
      private var var_116:FriendRequests;
      
      private var var_2009:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1101:IHabboNotifications;
      
      private var var_686:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2774 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_115 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2009 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_686.stop();
            this.var_686.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_686 = null;
         }
         ...
         if(this.var_147)
         {
            this.var_147.release(new IIDHabboMessenger());
            this.var_147 = null;
         }
         if(this.var_182)
         {
         ...
         if(this.var_1101)
         {
            this.var_1101.release(new IIDHabboNotifications());
            this.var_1101 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_863)
         {
            this.var_863.release(new IIDSessionDataManager());
            this.var_863 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2010 = new OpenedToWebPopup(this);
         }
         this.var_2010.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_118);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_762.createAvatarImage(param1,AvatarScaleType.const_111,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboRoomUICom_pet_command";
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_147 = param2 as IHabboMessenger;
      ...
      {
         this.var_1101 = param2 as IHabboNotifications;
      ...
      {
         this.var_863 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_116 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_115.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_1273,this.getText("friendlist.friends")));
         this.var_115.addCategory(new FriendCategory(FriendCategory.const_421,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_686)
         {
            this.var_686 = new Timer(120000);
            this.var_686.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_686.start();
         }
         ...
         {
            _loc5_ = this.var_115.findCategory(FriendCategory.const_421);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_116.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_116.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_476.findTab(FriendListTab.const_87).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_116.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_476.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2009.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_476.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_476.findTab(FriendListTab.const_87);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_863 || !this.var_116)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_863.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_116.vipLimit;
         }
         else if(this.var_863.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_38))
         {
            _loc2_ = this.var_116.clubLimit;
         }
         if(_loc2_ > this.var_116.limit)
         {
            this.var_116.limit = _loc2_;
         }
      }
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_176) as IBitmapWrapperWindow;
