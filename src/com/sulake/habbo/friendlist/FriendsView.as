package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2196:String = "bg";
      ...
      private var var_2549:IContainerButtonWindow;
      
      private var var_2550:IContainerButtonWindow;
      ...
      {
         this.var_2551 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2552 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2549 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2550 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_118).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_118,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         this._friendList.refreshButton(_loc3_,"follow_friend",param2.method_1,this.onFollowButtonClick,param2.id);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_118,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2551,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2552,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2549,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2550,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_118,param4);
         _loc6_.visible = true;
      }
