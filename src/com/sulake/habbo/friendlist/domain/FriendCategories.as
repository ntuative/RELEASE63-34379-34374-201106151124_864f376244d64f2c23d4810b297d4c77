   ...
   public class FriendCategories
   {
      ...
      public function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         try
         {
            ...
            {
               Logger.log("Got UPDATE: " + updatedFriend.id + ", " + updatedFriend.online + ", " + updatedFriend.name + ", " + updatedFriend.method_1);
               this.var_484.messenger.setFollowingAllowed(updatedFriend.id,updatedFriend.method_1 && updatedFriend.online);
               ...
               if(currentlyOnline && !updatedFriend.online)
               {
                  ...
                  this.var_484.notifications.addOfflineNotification(updatedFriend.name,updatedFriend.realName);
               }
               if(!currentlyOnline && updatedFriend.online)
               {
                  this.var_484.messenger.setOnlineStatus(updatedFriend.id,updatedFriend.online);
                  this.var_484.view.setNewMessageArrived();
                  this.var_484.notifications.addOnlineNotification(updatedFriend.name,updatedFriend.figure,updatedFriend.realName);
               }
      ...
      private function updateCategories(param1:Array) : void
      {
         ...
         this.findCategory(FriendCategory.const_1273).received = true;
