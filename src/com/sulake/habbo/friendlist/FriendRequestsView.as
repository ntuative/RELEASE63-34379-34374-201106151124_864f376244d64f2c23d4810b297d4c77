package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2054:String = "no_reqs_info";
      ...
      private var var_2128:IContainerButtonWindow;
      ...
      {
         this.var_2128 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2127 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2127.procedure = this.onDismissAllButtonClick;
         this.var_2128.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_194)
         {
         ...
         else if(param1.state == FriendRequest.const_1164)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_432 && _loc2_.state != FriendRequest.const_457)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2128,_loc1_);
         this.setEnabled(this.var_2127,_loc1_);
      }
