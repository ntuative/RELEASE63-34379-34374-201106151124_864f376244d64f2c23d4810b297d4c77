package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_295:AvatarImageCache;
      ...
      private var var_598:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1607);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_308.definition.geometryType);
         if(this.var_47 == null || _loc4_ != null && (this.var_47.width != _loc4_.width || this.var_47.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_308.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_555 = this.var_555 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1086);
         this.getCache().resetBodyPartCache(this.var_1086);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1608 = this._structure.sortActions(this.var_353);
         ...
         {
            this.var_858 = this._structure.getCanvasOffsets(this.var_1608,this._scale,this.var_102);
         }
      }
