package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2186:int = 6710886;
      
      private static const const_1537:int = 5000;
      
      private static const const_1398:Point = new Point(100,30);
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1267 = [];
         this.var_1445 = [AvatarEditorFigureCategory.const_998,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_255,AvatarEditorFigureCategory.const_986,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         this.var_24 = param1;
         if(var_1386 == null)
         {
            _loc4_ = this.var_24.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1386 = this.var_24.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1669 == null)
         {
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_86.position = const_1398;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_667 == null)
            {
               this.var_667 = this.var_24.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_77,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_667.addChild(this.var_60);
            }
            _loc3_ = this.var_667.getChildIndex(this.var_60);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1445);
         }
         if(param1.length != this.var_1267.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1267.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_245 = this.var_60.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_245.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_245.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1267.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1445;
      ...
      public function update() : void
      {
         ...
         if(this.var_24.manager.sessionData && this.var_24.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_38 && (this.var_1550 == AvatarEditorSideCategory.const_108 || this.var_2694))
         {
            _loc4_ = "null";
         }
         ...
         this.setViewToCategory(this.var_418);
      }
      ...
      {
         if(this.var_1550 == AvatarEditorSideCategory.const_108)
         {
            this.var_2694 = false;
            this.setSideContent(AvatarEditorSideCategory.const_575);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_575:
               break;
            case AvatarEditorSideCategory.const_578:
               _loc3_ = this.var_24.getSideContentWindowContainer(AvatarEditorSideCategory.const_578);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_334)
         {
            ...
            this.var_334 = this.var_24.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_334.procedure = this.stripClubDialogEventProc;
            this.var_334.center();
         }
         else
         {
            this.var_334.visible = true;
            this.var_334.center();
         }
      }
