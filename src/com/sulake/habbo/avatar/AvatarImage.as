package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1531:String = "Default";
      
      private static const const_1532:int = 2;
      
      private static const const_1530:String = AvatarSetType.const_39;
      ...
      protected var var_308:IActiveActionData;
      
      protected var var_1126:Boolean;
      
      protected var var_858:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_295:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_598:IAvatarDataContainer;
      
      protected var var_353:Array;
      
      protected var var_47:BitmapData;
      
      private var var_1086:IActiveActionData;
      ...
      private var var_2682:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this._figure = param3;
         this.var_295 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1530,const_1532);
         this.var_353 = new Array();
         this.var_1086 = new ActiveActionData(AvatarAction.const_394);
         this.var_1086.definition = this._structure.getActionDefinition(const_1531);
         this.resetActions();
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51 || param1 == AvatarSetType.const_39)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_283.length == 1 && this.var_102 == this.var_1974)
         {
            return this.var_102 + this.var_555 + this.var_662 % 4;
         }
      ...
      {
         if(param3 != this.var_2680 || param2 != this.var_2682 || param1 != this.var_2681)
         {
            this.var_2680 = param3;
            this.var_2682 = param2;
            this.var_2681 = param1;
            this.var_1933 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_308.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1396 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1396)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_308.definition.geometryType,this.var_102);
         this.var_47.lock();
         ...
         {
            if(this.var_598.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_598.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_308.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_308.definition.geometryType,this.var_102);
            ...
            case AvatarAction.const_419:
               switch(_loc3_)
               {
                  case AvatarAction.const_894:
                     if(this.var_102 == 0)
                     {
                        this.setDirection(AvatarSetType.const_39,4);
                     }
                     else
                     {
                        this.setDirection(AvatarSetType.const_39,2);
                     }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_353.push(new ActiveActionData(param1,param2,this.var_662));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_308 = this.var_1086;
         this.var_308.definition = this.var_1086.definition;
         this.resetBodyPartCache(this.var_1086);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_555 = "";
         this.var_283 = this._structure.sortActions(this.var_353);
         if(this.var_283 == null)
         {
            this.var_858 = new Array(0,0,0);
            if(this.var_1260 != "")
            {
               _loc1_ = true;
               this.var_1260 = "";
         ...
         {
            this.var_858 = this._structure.getCanvasOffsets(this.var_283,this._scale,this.var_102);
            for each(_loc4_ in this.var_283)
            {
               this.var_555 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_352)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1546 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1546 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1260 != this.var_555)
            {
               _loc1_ = true;
               this.var_1260 = this.var_555;
            }
         }
         this.var_1545 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_283)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1083 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1932 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_598 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_339 || _loc1_.actionType == AvatarAction.const_303 || _loc1_.actionType == AvatarAction.const_395)
               {
                  this.var_1083 = true;
               }
            }
