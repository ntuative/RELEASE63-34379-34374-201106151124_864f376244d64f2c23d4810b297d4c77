package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1533:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1534:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_557:HabboAvatarEditorManager;
      
      private var var_1019:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_557 = param2;
         this.var_1019 = this.var_557.avatarRenderManager.getFigureData(AvatarType.const_127);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_664["null"] = new FigureData(this);
         this.var_664["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_664["null"];
         var _loc3_:FigureData = this.var_664["null"];
         _loc2_.loadAvatarData(const_1533,FigureData.const_92);
         _loc3_.loadAvatarData(const_1534,FigureData.FEMALE);
         this.var_115 = new Map();
         this.var_556 = new Map();
         this.var_115.add(AvatarEditorFigureCategory.const_998,new BodyModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_255,new TorsoModel(this));
         this.var_115.add(AvatarEditorFigureCategory.const_986,new LegsModel(this));
         ...
         this.var_556.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
         this.var_556.add(AvatarEditorSideCategory.const_578,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc5_:FigureData = this.var_664[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1019.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1019.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_998);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_556.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_664[this.var_1118];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_557.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_557.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_557.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_557.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1981)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1386.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      {
         return this.var_557.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_556.getValue(AvatarEditorSideCategory.const_108);
      }
