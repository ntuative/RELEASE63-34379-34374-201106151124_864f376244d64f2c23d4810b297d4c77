package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1334:String = "AVATAR_STRUCTURE_DONE";
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2268.appendXML(this.var_1706);
         dispatchEvent(new Event(AvatarStructureDownload.const_1334));
      }
