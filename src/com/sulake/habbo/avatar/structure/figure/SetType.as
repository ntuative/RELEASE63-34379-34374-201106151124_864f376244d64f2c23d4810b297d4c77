package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2959 = parseInt(param1.@paletteid);
         this.var_723 = new Dictionary();
         this.var_723["F"] = new Dictionary();
         this.var_723["M"] = new Dictionary();
         this.var_723["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_723["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_723["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_723["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_723[param1.toUpperCase()][Math.min(param2,1)];
      }
