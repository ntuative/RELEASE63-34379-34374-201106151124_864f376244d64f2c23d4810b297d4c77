package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2757 = parseInt(param1.@precedence);
         this.var_2753 = String(param1.@activepartset);
         this.var_2759 = String(param1.@assetpartdefinition);
         this.var_2755 = String(param1.@lay);
         this.var_872 = String(param1.@geometrytype);
         this.var_2363 = Boolean(parseInt(param1.@main));
         this.var_2756 = Boolean(parseInt(param1.@name_8));
         this.var_2758 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboRoomUICom_pet_command"));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_858.getValue(param1) == null)
         {
            this.var_858.add(param1,new Map());
         }
         var _loc4_:Map = this.var_858.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_858.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
