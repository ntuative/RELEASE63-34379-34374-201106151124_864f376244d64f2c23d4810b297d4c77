package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_2114 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2920 = parseInt(_loc2_,16);
         this.var_2918 = parseInt(_loc3_,16);
         ...
         this.var_772 = new ColorTransform(this.var_1940,this.var_1938,this.var_1939,this._alphaMultiplier);
         this.var_1367 = this.generatePaletteMapForGrayscale(this.var_2918,this.var_2920);
      }
      ...
      {
         return this.var_1367.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1367.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1367.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1367.getValue("alphas") as Array;
      }
