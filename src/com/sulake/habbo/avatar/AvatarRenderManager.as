package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2299:String = "hd-99999-99999";
      ...
      private var var_796:PaletteManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_678 = RenderMode.const_1918;
         ...
         this.var_118.add(AvatarType.const_127,_loc4_);
         ...
         this.var_796 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_325.init();
         this.var_796.init();
         _loc2_ = this.var_118.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_118.getValue(AvatarType.const_127) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1334,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1044)
         {
            if(this.var_2531 && this.var_2530 && this.var_2529)
            {
               this.var_1044 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_118.getValue(AvatarType.const_127) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1868)
         {
            this.var_1868 = new AvatarFigureContainer(this.const_2299);
         }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1960)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_118.getValue(AvatarType.const_127) as AvatarStructure;
