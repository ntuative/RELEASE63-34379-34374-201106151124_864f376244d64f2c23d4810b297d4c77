   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1930)
            {
               if("QuestsList" == this.var_182.getKey("use.default.localizations","QuestsList"))
               {
                  _loc5_ = this.var_182.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_195,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_195,this.onLocalizationLoaded);
         if(this.var_182.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_182.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_195,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_195,this.onLocalizationOverrideLoaded);
         unlock();
      }
