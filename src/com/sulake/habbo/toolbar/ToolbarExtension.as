package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1560:uint = 16777215;
      
      private static const const_1562:uint = 12247545;
      
      private static const const_1559:String = "HELP";
      
      private static const const_1561:String = "ROOMINFO";
      ...
      private const const_914:int = 41;
      ...
      {
         this.var_64.removeListItem(this.var_394);
      }
      
      public function showRoomInfo() : void
      {
         this.var_64.addListItemAt(this.var_394,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_971;
         _loc3_.y = this.const_914;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_668)
         {
            this.var_668 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1559);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1561);
               break;
            case "confirm":
               if(false)
               {
