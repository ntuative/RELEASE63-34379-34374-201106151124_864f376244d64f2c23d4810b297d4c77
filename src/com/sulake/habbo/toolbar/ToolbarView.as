package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1398:Point = new Point(3,3);
      
      private static const const_1498:uint = 7433577;
      
      private static const const_1499:uint = 5723213;
      
      private static const const_466:String = "_hover";
      
      private static const const_468:String = "_normal";
      
      private static const const_467:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1398;
         ...
         this.var_323 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_323);
         var _loc14_:ITextWindow = this.var_323.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_323.visible = false;
         this.var_323.x = _loc13_.width - this.var_323.width - const_467;
         this.var_323.y = const_467;
         this.var_2488 = this.isNewItemsNotificationEnabled();
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_323 != null && this.var_2488)
               {
                  this.var_323.visible = true;
               }
               break;
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_852:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_817:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_466);
               this.setIconBgHoverState(_loc3_,const_466);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_466 ? this.var_1485 : this.var_1486;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_466)
         {
            param1.color = const_1498;
         }
         else
         {
            param1.color = const_1499;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1486 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1485)
         {
            this.var_1485.dispose();
         }
         this.var_1485 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_980.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_467;
            _loc2_.y = const_467;
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","QuestsList") == "HabboRoomUICom_pet_command";
      }
   }
}
