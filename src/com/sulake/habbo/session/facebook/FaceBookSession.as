package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1511:String = "sendAccessTokenToServer";
      
      private static const const_1512:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1511,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1512,this.jsFaceBookLogOutCallback);
