package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_415.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_415)
         {
            this.var_415.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_415.reset();
            this.var_415 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_61 == null)
         {
            this.var_61 = IWindowContainer(this._navigator.getXmlWindow(this.var_1124));
         ...
         this.var_61.x = _loc2_.x + this.var_2955 + param1.width;
