package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_950:TextFieldManager;
      ...
      private var var_1163:ICheckBoxWindow;
      
      private var var_754:ICheckBoxWindow;
      
      private var var_1744:ITextWindow;
      
      private var var_946:IDropMenuWindow;
      ...
      {
         if(param1 != this.var_362 || this.var_1166 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1166 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1837)
         {
            this.var_756.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1966)
         {
            this.var_756.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1799)
         {
            this.var_1161.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1842)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1964)
         {
         ...
         {
            this.var_950.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_756.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_756 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1161 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_950 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1164 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1160 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1162 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1163 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_754 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1744 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_946 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_949 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2318 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         ...
         this.var_1742 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1439 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_238 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1167 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1440 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1440.mouseThreshold = 0;
         this.var_1440.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1167.visible = false;
         if(!this.var_1441)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1742.visible = this.var_1441;
         this.populateForm();
         if(this.var_755)
         {
         ...
         else
         {
            ...
            this.var_1439.visible = true;
            this.var_2318.visible = this.var_1441;
            this.var_1165.height = Util.getLowestPoint(this.var_1165) + 4;
         }
         this.var_1440.text = !!this.var_755 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1165.name,this.var_1159.name,this.var_1439.name,this.var_1742.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_756.setText(_loc1_.name);
         this.var_1161.setText(_loc1_.description);
         this.var_950.setText("");
         this.var_1164.setText("");
         ...
         {
            case RoomSettingsData.const_232:
         ...
         if(this.var_1163)
         {
            ...
            {
               this.var_1163.select();
            }
            else
            {
               this.var_1163.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_754);
            this.disableWindow(this.var_946);
            this.disableWindow(this.var_949);
            this.disableWindow(this.var_1744);
         }
         else
         {
            this.enableWindow(this.var_754);
            this.enableWindow(this.var_946);
            this.enableWindow(this.var_949);
            this.enableWindow(this.var_1744);
         }
         if(this.var_754)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_754.unselect();
            }
         }
         if(this.var_946)
         {
            this.var_946.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_949)
         {
            this.var_949.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_756.getText();
         _loc2_.description = this.var_1161.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_232;
               break;
         ...
         {
            _loc8_ = this.var_950.getText();
            _loc9_ = this.var_1164.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_950.clearErrors();
               this.var_1164.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1160.isSelected;
         _loc2_.allowFoodConsume = this.var_1162.isSelected;
         _loc2_.allowWalkThrough = this.var_1163.isSelected;
         _loc2_.hideWalls = this.var_754.isSelected;
         _loc2_.wallThickness = this.var_946.selection - 2;
         _loc2_.floorThickness = this.var_949.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_948,_loc2_.tags);
         this.addTag(this.var_947,_loc2_.tags);
         this.clearErrors();
         this.var_1166 = _loc2_.roomId;
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         if(this.var_238 == null || this.var_238.disposed)
         {
            return;
         }
         Util.hideChildren(this.var_238);
         var _loc1_:IWindow = this.var_238.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_238.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_56.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_238.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_238.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_238.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_238.findChildByName("flat_controllers_footer"));
            if(this.var_56 != null && this.var_56.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_238,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_238.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
