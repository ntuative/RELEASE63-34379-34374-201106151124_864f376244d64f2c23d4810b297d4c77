package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_338:MainViewCtrl;
      
      private var var_684:RoomInfoViewCtrl;
      
      private var var_1302:RoomCreateViewCtrl;
      ...
      private var var_2670:RoomThumbnailRenderer;
      
      private var var_950:GuestRoomPasswordInput;
      
      private var var_333:GuestRoomDoorbell;
      
      private var var_1301:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_338 = new MainViewCtrl(this);
         this.var_684 = new RoomInfoViewCtrl(this);
         this.var_1302 = new RoomCreateViewCtrl(this);
         this.var_2670 = new RoomThumbnailRenderer(this);
         this.var_950 = new GuestRoomPasswordInput(this);
         this.var_333 = new GuestRoomDoorbell(this);
         this.var_476 = new Tabs(this);
         this.var_1301 = new OfficialRoomEntryManager(this);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_338.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_338.startSearch(Tabs.const_226,Tabs.const_415,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_338.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_338.startSearch(Tabs.const_271,Tabs.const_275);
         this.var_476.getTab(Tabs.const_271).tabPageDecorator.tabSelected();
      }
