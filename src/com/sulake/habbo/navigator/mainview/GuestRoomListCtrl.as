package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_597 = IScrollbarWindow(this.var_201.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1989,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_232,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_536.visible && this.var_2462)
         {
            return;
         }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_132:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_232:
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2461 - _loc2_.stageX);
         this.var_2461 = _loc2_.stageX;
         this.var_2462 = _loc3_ > 2;
      }
   }
}
