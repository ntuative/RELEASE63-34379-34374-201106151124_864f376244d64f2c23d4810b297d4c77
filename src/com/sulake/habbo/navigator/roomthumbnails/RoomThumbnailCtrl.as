package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1730:IButtonWindow;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1731 = IButtonWindow(this.find("bg_tab"));
         this.var_1730 = IButtonWindow(this.find("top_tab"));
         this.var_1729 = IButtonWindow(this.find("obj_tab"));
         this.var_2314 = IWindowContainer(this.find("tile_grid"));
         this.var_2315 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1731,this.onBgTabButton);
         Util.setProcDirectly(this.var_1730,this.onTopTabButton);
         Util.setProcDirectly(this.var_1729,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1731,this.var_77.mode != ThumbnailEditorModel.const_36);
         this.setEnabled(this.var_1730,this.var_77.mode != ThumbnailEditorModel.const_64);
         this.setEnabled(this.var_1729,this.var_77.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2315;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2314;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_655)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_343,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
