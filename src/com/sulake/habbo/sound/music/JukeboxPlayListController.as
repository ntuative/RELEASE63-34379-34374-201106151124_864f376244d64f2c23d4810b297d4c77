package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_841 = [];
         this.var_841.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_841.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_841.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_655 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_239.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_122,_loc3_.syncCount / 1000,0,1,1);
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_899.indexOf(_loc5_) < 0)
               {
                  this.var_899.push(_loc5_);
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_589[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_899.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
