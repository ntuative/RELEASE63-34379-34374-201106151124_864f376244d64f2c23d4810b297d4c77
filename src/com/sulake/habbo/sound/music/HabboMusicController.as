package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1479:int = HabboMusicPrioritiesEnum.const_122;
      ...
      private var var_533:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_841.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_841.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_841)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_885,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_257,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_762,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_790,this.onSoundMachineDispose);
         this.var_1205 = new Timer(1000);
         this.var_1205.start();
         this.var_1205.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1816)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_453)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_274)
            {
               ...
               {
                  _loc3_ = this.var_274.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_885,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_257,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_762,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_790,this.onSoundMachineDispose);
            }
      ...
      private function method_7(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
      ...
      public function playSong(param1:int, param2:int, param3:Number = 0, param4:Number = 0.0, param5:Number = 0.5, param6:Number = 0.5) : Boolean
      {
         ...
         if(!this.method_7(param2,param1,param3,param4,param5,param6))
         {
            return false;
         }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_274.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_274.length)
         {
            ...
            if(_loc3_.id != this.var_1471 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_322.length)
         {
            if(this.var_322[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_274.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_274.add(_loc6_.id,_loc10_);
               ...
               while(this.var_779.indexOf(_loc6_.id) != -1)
               {
                  this.var_779.splice(this.var_779.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1816 = this.getSongRequestCountAtPriority(param1);
         this.var_1471 = param2;
         if(this._priorityPlaying <= const_1479)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2431 != param1.id || _loc3_ > this.var_2432 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2431 = param1.id;
            this.var_2432 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_533 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_533 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
