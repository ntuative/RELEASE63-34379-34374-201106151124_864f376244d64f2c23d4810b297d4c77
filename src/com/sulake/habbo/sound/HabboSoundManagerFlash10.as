package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1665:int = 60;
      
      private static const const_1666:int = 25165823;
      
      private static const const_1667:int = 16777215;
      ...
      private var var_937:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_979,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1283:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1906:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_717.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1365.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_298,events);
         _loc5_.volume = this.var_937;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_298.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1101.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1101 = IHabboNotifications(param2);
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1919,this.var_890));
         this.var_890 = -1;
         this.var_891 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_937 * 100)));
         }
      }
      ...
      {
         this.var_937 = param1;
         this.var_239.updateVolume(this.var_937);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_717.getValue(param1) != null)
         {
            _loc2_ = this.var_717.remove(param1);
            if(this.var_298.getValue(_loc2_) == null)
            {
               this.var_1627.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1627,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1627,_loc2_,TraxSample.const_1934,TraxSample.const_1707);
               this.var_298.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1366.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1665 && this.var_1366.length > 0)
            {
               _loc3_ = this.var_1366.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_717.length == 0 && this.var_890 != -1)
            {
               this.var_891.ready = true;
               _loc4_ = this.var_890;
               this.var_890 = -1;
               this.var_891 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_979,_loc4_));
               if(this.var_2911)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_891 == null && this.var_1365.length > 0)
         {
            _loc1_ = this.var_1365.getKey(0);
            _loc2_ = this.var_1365.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_979,_loc1_));
               }
               else
               {
                  this.var_891 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_298.getKey(_loc4_);
            _loc6_ = this.var_298.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1666)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1667 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_298.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_298.remove(_loc11_);
               }
