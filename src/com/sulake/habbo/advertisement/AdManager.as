package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_253:Timer;
      
      private var var_402:AdImageRequest;
      
      private var var_1335:BitmapData = null;
      
      private var var_1334:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2825 = this._config.getKey("interstitial.enabled","QuestsList") == "HabboRoomUICom_pet_command";
         this.var_2824 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2822 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2046 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_253 != null && this.var_253.running)
         {
            this.var_253.reset();
            return false;
         }
         ...
         if(this.var_2046 > 0 && this.var_2045 >= this.var_2046)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1336;
         if(_loc1_ > this.var_2824)
         {
            ++this.var_2045;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1596 = _loc2_.imageUrl;
         this.var_2823 = _loc2_.clickUrl;
         this.var_1336 = getTimer();
         if(this.var_1596 != "")
         {
            _loc3_ = this.var_1596;
            ...
            {
               this.var_253 = new Timer(this.var_2822,1);
               this.var_253.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_253.running)
            {
               this.var_253.reset();
            }
            this.var_253.start();
            _loc4_ = new URLRequest(this.var_1596);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_539,param1.bitmapData,this.var_2823));
            this.var_1336 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_636));
         }
      }
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_402 != null)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_514,this.var_402.roomId,this.var_402.roomCategory,_loc4_,_loc2_.assetName,this.var_402.clickURL,this.var_1335,this.var_1334));
            this.var_402 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1335 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1334 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_822,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
