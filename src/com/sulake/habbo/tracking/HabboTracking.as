package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_223:IHabboFriendList;
      ...
      private var var_450:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_450 = new ToolbarClickTracker(this);
         this.var_1509 = new Array(const_1071);
         var _loc4_:int = 0;
         while(_loc4_ < const_1071)
         {
            this.var_1509[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1763,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_820,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1377,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_223)
            {
               ...
               {
                  Component(this.var_223).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_223).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_223).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_223).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_223).events.removeEventListener(HabboFriendListTrackingEvent.const_608,this.onFriendlistTrackingEvent);
               }
               this.var_223.release(new IIDHabboFriendList());
               this.var_223 = null;
            }
            if(this.var_195)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_182)
         {
            if(this.var_278 != null)
            {
               this.var_278.configuration = this.var_182;
            }
            if(this.var_279 != null)
            {
               this.var_279.configuration = this.var_182;
            }
            ...
            if(this.var_182)
            {
               ...
               if(this.var_451 != null)
               {
                  this.var_451.configure(this.var_182);
               }
               if(this.var_450 != null)
               {
                  this.var_450.configure(this.var_182);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_1004,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_939,this.onHotelViewEvent);
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_939)
         {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1820);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_1004:
               this.trackLoginStep(HabboLoginTrackingStep.const_1929,String(this._communication.port));
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_182)
            {
               if(this.var_182.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1509)
                  {
      ...
      {
         this.var_223 = param2 as IHabboFriendList;
         Component(this.var_223).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_223).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_223).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_223).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_223).events.addEventListener(HabboFriendListTrackingEvent.const_608,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_608:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1377,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_820,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_321.events.addEventListener(AdEvent.const_514,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_450)
         {
            this.var_450.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_450)
         {
            this.var_450.track(param1.type);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1882;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1882);
         }
         if(this.var_545 > -1 && _loc2_ - this.var_545 > 15000)
         {
            ++this.var_1883;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1883);
         }
         this.var_545 = _loc2_;
         if(this.var_279 != null)
         {
            this.var_279.update(param1,this.var_545);
         }
         if(this.var_278 != null)
         {
            this.var_278.update(param1,this.var_545);
         }
         if(this.var_451 != null)
         {
            this.var_451.trackUpdate(param1,this,this.var_545);
         }
         if(this.var_641 != null)
         {
            this.var_641.update(this.var_545);
         }
      }
   }
}
