package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1025:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_666 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_666.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1025 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1025.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_666.scrollV;
         this.var_666.removeGridItems();
         this.var_1025.removeGridItems();
         var _loc2_:Array = this.var_77.getBadges(BadgesModel.const_667);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_666.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_666.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_77.getBadges(BadgesModel.const_366);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1025.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_77.getBadges(BadgesModel.const_366);
      ...
      {
         var _loc2_:int = this.var_666.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1025.getGridItemIndex(param1.window);
