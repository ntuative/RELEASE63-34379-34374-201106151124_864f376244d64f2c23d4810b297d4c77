package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1533:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_654 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_654.width;
         this.var_105 = this.var_654.height;
         this.var_1245 = param5;
         this.var_1011 = param6;
         this.var_243 = Math.floor(this.var_1245 / this._thumbWidth);
         this.var_29 = new BitmapData(this.var_1245,this.var_1011);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_29 = new BitmapData(Math.max(this.var_243 * this._thumbWidth,this.var_1245),Math.max(this.var_653 * this.var_105,this.var_1011),true,16777215);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1533.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_29.height < this.var_1011)
         {
            _loc12_ = new BitmapData(this.var_29.width,this.var_1011);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_654.width,this.var_654.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_654.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_654,this.var_654.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
