package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1486:int = 100;
      
      private static const const_1487:int = 1000;
      ...
      private var var_1472:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_442 = [];
         this.var_443 = [];
         this.var_627 = new Timer(const_1486,1);
         this.var_627.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_150,this.onObjectPlaced);
               }
            ...
            {
               this.var_627.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_627.stop();
               this.var_627 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_35)
            {
               ...
               {
                  this.var_1472 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1472;
            }
            else
            {
         ...
         this.var_28.setInventoryCategoryInit(InventoryCategory.const_76);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_780 == null)
         {
            this.var_780 = this._windowManager.buildFromXML(this.var_2437) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_780.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_780.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_76 && this.var_28.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_274:
                  this.var_28.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         this.var_28.checkCategoryInitilization(InventoryCategory.const_450);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_628.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_201)
                  {
                     _loc7_ = _loc9_;
                  }
      ...
      {
         return getTimer() < this.var_2438 + const_1487;
      }
      ...
      {
         return this.var_28.getSubCategoryViewId() == InventorySubCategory.const_320;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_329 || _loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_335)
         {
            if(param1)
            {
               return false;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_408:
               return this.var_442.length;
            case UnseenItemCategoryEnum.const_409:
               return this.var_443.length;
            default:
               return this.var_442.length + this.var_443.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_44:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_409));
                  this.var_443 = [];
            ...
            case const_35:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_408));
                  this.var_442 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
