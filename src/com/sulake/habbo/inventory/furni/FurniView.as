package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2040:int = 0;
      ...
      private static const const_1118:int = 42;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_399.add(FurniModelCategory.const_35,new FurniGridView(this.var_77,FurniModelCategory.const_35,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_399.getValue(this.var_475);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_77.getCategoryContent(this.var_475);
         ...
         if(this.var_2742 == _loc2_)
         {
            return;
         }
         this.var_2742 = _loc2_;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_408) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_77.getUnseenItemCount(UnseenItemCategoryEnum.const_409) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_77.getGroupItemInIndex(_loc3_,this.var_475);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            {
               if(_loc5_.category == FurniCategory.const_201)
               {
