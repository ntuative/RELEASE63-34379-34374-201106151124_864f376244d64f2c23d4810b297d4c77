package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_1949:IWindowContainer;
      
      private var var_226:Timer;
      
      private var var_1024:GroupItem;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1949 = this.createMinimizedWindow();
         }
         if(!this.var_2693)
         {
            return this.var_79;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_79)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1092) : uint(const_1091);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1092) : uint(const_1091);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1024)
         {
            this.var_1024.isSelected = false;
            this.var_1024 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1876)
            {
            ...
            this.var_665.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_509);
            this.var_665.show();
         }
         ...
         if(this.var_198.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_665.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_509);
               }
            }
            else
            {
