package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1427:int = 250;
      
      private static const const_1430:int = 100;
      
      private static const const_1429:int = 180;
      
      private static const const_1428:int = 200;
      ...
      {
         this.var_366 = new Timer(const_1427,1);
         this.var_367 = new Timer(const_1430,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         {
            this.var_957 = _loc3_.content as BitmapData;
         }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1429,param3.width),Math.min(const_1428,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1776);
         switch(this.var_1776)
         {
            case const_1294:
               this.var_93.x = -1 * this.var_93.width - const_1042;
               break;
            case const_509:
               this.var_93.x = this._parent.width + const_1042;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1294:
               _loc2_.bitmap = this.var_957.clone();
               _loc2_.width = this.var_957.width;
               _loc2_.height = this.var_957.height;
               _loc2_.y = (this.var_93.height - this.var_957.height) / 2;
            ...
            case const_509:
               ...
               _loc2_.y = (this.var_93.height - this.var_761.height) / 2;
