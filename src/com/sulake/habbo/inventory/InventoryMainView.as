package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_467:int = 3;
      ...
      private const const_2018:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_28.inventoryViewOpened(this.var_867);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_401 != null && this.var_401 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_401 || !this.var_28.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_137:
               ...
               break;
            case InventoryCategory.const_241:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_401);
         }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_401 == InventoryCategory.const_137)
            {
               this.toggleCategoryView(InventoryCategory.const_137);
            }
            else if(this.var_401 == InventoryCategory.const_76)
            {
               this.toggleCategoryView(InventoryCategory.const_76);
            }
            else if(this.var_28 != null)
            {
               this.var_28.toggleInventoryPage(InventoryCategory.const_76);
            }
         }
      }
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_467;
            _loc3_.y = const_467;
         }
         return _loc3_;
      }
