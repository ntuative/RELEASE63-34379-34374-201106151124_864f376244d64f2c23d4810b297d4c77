package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1419:int = 13421772;
      
      private static const const_1420:int = 10275685;
      ...
      private const const_2030:Number = 1;
      
      private const const_2031:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2316 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2219 == FurniModelCategory.const_35)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1511));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2218);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_879)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2031;
               _loc1_.blend = this.const_2031;
            }
            else
            {
               this._window.blend = this.const_2030;
               _loc1_.blend = this.const_2030;
            }
         }
         this.var_1461.color = !!this.var_1510 ? uint(const_1420) : uint(const_1419);
         this.var_2316.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2220 && this.getRecyclableCount() > 0)
            {
