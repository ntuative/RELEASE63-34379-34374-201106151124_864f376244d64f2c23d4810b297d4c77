package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2325:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_648,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_67.getValue(InventoryCategory.const_76));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_67.getValue(InventorySubCategory.const_320));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_67.getValue(InventoryCategory.EFFECTS));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_67.getValue(InventoryCategory.const_241));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_67.getValue(InventorySubCategory.const_1174));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_67.getValue(InventoryCategory.const_137));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_67.getValue(InventoryCategory.const_450) as MarketplaceModel;
      }
      ...
      {
         return this.var_121.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_121.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_121.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_121.clubHasEverBeenMember;
      }
      ...
      {
         this.var_121.clubPeriods = param1;
         this.var_121.clubDays = param2;
         this.var_121.clubHasEverBeenMember = param3;
         this.var_121.isVIP = param4;
      ...
      {
         this.var_408 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_648,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_408 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_67.add(InventoryCategory.const_450,_loc1_);
         ...
         this.var_67.add(InventoryCategory.const_76,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_408);
         this.var_67.add(InventoryCategory.const_241,_loc3_);
         ...
         this.var_67.add(InventoryCategory.EFFECTS,_loc4_);
         ...
         this.var_67.add(InventorySubCategory.const_320,_loc5_);
         ...
         this.var_67.add(InventorySubCategory.const_1174,_loc6_);
         ...
         this.var_67.add(InventoryCategory.const_137,_loc7_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_320:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2325);
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2953)
         {
            this.var_2953 = _loc1_;
