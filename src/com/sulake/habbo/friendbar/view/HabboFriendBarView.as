package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends Component implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1446:int = 127;
      ...
      private static const const_1447:Boolean = false;
      
      private static const const_681:int = 3;
      
      private static const const_1433:String = "arrow";
      
      private static const const_1438:String = "left";
      
      private static const const_1444:String = "right";
      
      private static const const_1437:String = "bar_xml";
      
      private static const const_1440:String = "toggle_xml";
      ...
      private static const const_680:String = "list";
      
      private static const const_462:String = "header";
      
      private static const const_311:String = "canvas";
      
      private static const ICON:String = "icon";
      
      private static const PIECES:String = "pieces";
      
      private static const const_1435:String = "button_left";
      
      private static const const_1441:String = "button_right";
      
      private static const const_1439:String = "button_left_page";
      
      private static const const_1436:String = "button_right_page";
      
      private static const const_1442:String = "button_left_end";
      
      private static const const_1431:String = "button_right_end";
      
      private static const const_1392:String = "button_close";
      
      private static const const_1445:String = "button_open";
      ...
      private var var_524:FriendListIcon;
      
      private var var_368:MessengerIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_52)
            {
               if(!this.var_52.disposed)
               {
                  ...
                  {
                     this.var_52.events.removeEventListener(FriendBarUpdateEvent.const_1014,this.onRefreshView);
                     this.var_52.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_52.events.removeEventListener(FriendRequestUpdateEvent.const_947,this.onFriendRequestUpdate);
                     this.var_52.events.removeEventListener(NewMessageEvent.NEW_INSTANT_MESSAGE,this.onNewInstantMessage);
                     this.var_52.events.removeEventListener(NotificationEvent.const_805,this.onFriendNotification);
                  }
            ...
            if(this._windowManager)
            {
               ...
               {
                  this._windowManager.getWindowContext(const_465).getDesktopWindow().removeEventListener(WindowEvent.const_42,this.onDesktopResized);
            ...
            if(this.var_762)
            {
               ...
               {
                  this.var_762.release(new IIDAvatarRenderManager());
                  this.var_762 = null;
               }
            }
            if(this.var_958)
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_959;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_51.findChildByName(const_77) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_680) as IItemListWindow;
         ...
         if(this.var_1457)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_72.length + _loc15_ < const_681)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_72.length,const_681 - this.var_72.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_52.events.addEventListener(FriendBarUpdateEvent.const_1014,this.onRefreshView);
         this.var_52.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_52.events.addEventListener(FriendRequestUpdateEvent.const_947,this.onFriendRequestUpdate);
         this.var_52.events.addEventListener(NewMessageEvent.NEW_INSTANT_MESSAGE,this.onNewInstantMessage);
         this.var_52.events.addEventListener(NotificationEvent.const_805,this.onFriendNotification);
      }
      ...
      {
         this.var_958 = param2 as IHabboLocalizationManager;
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_304 = this.var_52;
         Tab.var_594 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = this._windowManager;
         Tab.var_2202 = this.var_958;
         Tab.var_2184 = this.var_1458;
         Token.WINDOWING = this._windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1437);
         this.var_51 = this._windowManager.buildFromXML(_loc1_.content as XML,const_465) as IWindowContainer;
         this.var_51.x = const_679;
         this.var_51.y = this.var_51.parent.height - (this.var_51.height + const_1434);
         this.var_51.width = this.var_51.parent.width - (const_679 + const_1044);
         this.var_51.setParamFlag(WindowParam.const_289,true);
         this.var_51.procedure = this.barWindowEventProc;
         if(const_1447)
         {
            _loc1_ = assets.getAssetByName(const_1440);
            this.var_217 = this._windowManager.buildFromXML(_loc1_.content as XML,const_465) as IWindowContainer;
            this.var_217.x = this.var_51.x;
            this.var_217.y = this.var_51.y;
            this.var_217.setParamFlag(WindowParam.const_289,true);
            this.var_217.visible = false;
            this.var_217.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_51.findChildByName(const_1043));
         ...
         this.var_524 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_51.findChildByName(const_1432));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_368 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_368.enable(false);
         this.visible = true;
         this._windowManager.getWindowContext(const_465).getDesktopWindow().addEventListener(WindowEvent.const_42,this.onDesktopResized);
      }
      
      private function onAvatarRendererAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_762 = param2 as IAvatarRenderManager;
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(this.var_762)
         {
            _loc3_ = this.var_762.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_51.findChildByName(const_680) as IItemListWindow;
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     ...
                     if(_loc10_)
                     {
                        ...
                        if(_loc11_)
                        {
                           _loc12_ = _loc11_.findChildByName(const_311) as IBitmapWrapperWindow;
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_959 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_524)
         {
            this.var_524.notify(this.var_52.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_368)
         {
            if(param1.notify)
            {
               this.var_368.notify(true);
            }
            else
            {
               this.var_368.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            _loc4_ = this.var_52.numFriends + (!!this.var_1457 ? 1 : 0) + (this.var_52.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               case const_1435:
         ...
         if(param1.type == WindowEvent.const_605)
         {
            this.deSelect(true);
         }
      }
      ...
      {
         var _loc2_:Icon = param1.window.name == const_1043 ? this.var_524 : this.var_368;
         switch(param1.type)
         {
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1438,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         if(!disposed)
         {
            if(this.var_51)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_72.length < const_681)
                     {
                        param1 = true;
                     }
                     else if(this.var_72.length < this.var_52.numFriends + (!!this.var_1457 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      {
         var _loc1_:IWindowContainer = this.var_51.findChildByName(const_77) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1045) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_680) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1446 + _loc3_.spacing);
      }
