package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_1995:String = "friendRequestsTabXML";
      ...
      protected static const const_668:String = "request_entity_list";
      
      protected static const const_699:String = "name";
      
      protected static const const_1993:String = "badge_counter";
      
      protected static const BUTTON_ACCEPT_ALL:String = "button_accept_all";
      
      protected static const const_1994:String = "click_area_discard_all";
      
      protected static const const_1392:String = "button_close";
      
      protected static const const_1996:String = "button_accept";
      
      protected static const const_1997:String = "click_area_discard";
      
      private static var var_1422:FriendRequestsTab;
      
      private static const const_75:uint = 4292915260;
      
      private static const const_1032:uint = 4294956373;
      
      private static const const_1416:uint = 4289498176;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1422 ? var_1422 : new FriendRequestsTab();
         _loc2_.var_166 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_1993).caption = String(param1.length);
         return _loc2_;
      }
         ...
         if(!disposed)
         {
            if(!var_166)
            {
               if(_window)
               {
                  ...
                  if(_loc1_)
                  {
                     _loc2_ = _loc1_.content.getChildByName(const_668) as IItemListWindow;
                     if(_loc2_)
                     {
         ...
         if(!selected)
         {
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1710)
                  {
                     _loc3_ = _loc2_.content.getChildByName(const_668) as IItemListWindow;
                     if(_loc3_)
                     {
                        _loc7_ = 0;
                        _loc8_ = 0;
                        ...
                        {
                           _loc4_ = this.var_1148.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1416) : uint(ENTITY_COLOR_ODD);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_699).caption = _loc5_.name;
                           _loc6_ = _loc4_.getChildByName(const_311) as IBitmapWrapperWindow;
                           _loc9_ = var_594.getAvatarFaceBitmap(_loc5_.figure);
                           if(_loc9_)
                           {
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1995).content as XML) as IWindowContainer;
         ...
         var _loc7_:IItemListWindow = _loc4_.content.getChildByName(const_668) as IItemListWindow;
         this.var_1148 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_ = IBitmapWrapperWindow(param1.findChildByName(const_311));
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1018)).underline = false;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case const_1392:
                  if(selected)
                  {
                     var_594.deSelect(true);
                  }
                  break;
               case BUTTON_ACCEPT_ALL:
                  var_304.acceptAllFriendRequests();
                  break;
               case const_1994:
                  var_304.declineAllFriendRequests();
                  break;
               case const_1996:
                  var_304.acceptFriendRequest(param2.parent.id);
                  break;
               case const_1997:
                  var_304.declineFriendRequest(param2.parent.id);
            }
         }
      }
      ...
      public function avatarImageReady(param1:FriendRequest, param2:BitmapData) : void
      {
         ...
         if(_loc3_)
         {
            _loc4_ = _loc3_.content.getChildByName(const_668) as IItemListWindow;
            if(_loc4_)
            {
               _loc6_ = 0;
               while(_loc6_ < _loc4_.numListItems)
               {
                  ...
                  {
                     _loc7_ = _loc5_.getChildByName(const_311) as IBitmapWrapperWindow;
