package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1524:String = "entity_xml";
      
      private static const const_1525:String = "facebook_piece_xml";
      
      private static const const_1526:String = "controls_piece_xml";
      
      protected static const PIECES:String = "pieces";
      
      protected static const const_378:String = "icons";
      
      protected static const const_462:String = "header";
      
      protected static const const_1389:String = "facebook";
      
      protected static const const_1391:String = "controls";
      
      protected static const const_311:String = "canvas";
      
      protected static const const_699:String = "name";
      
      protected static const const_1041:String = "btn_message";
      
      protected static const const_1019:String = "icon_message";
      
      protected static const const_1390:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1018:String = "label";
      
      protected static const const_576:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1032:uint = 13891476;
      
      private static const const_1085:String = null;
      
      private static const const_691:String = "icon_tag_notify";
      
      private static const const_1523:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_473:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1389) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1391) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_576,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1525).content as XML) as IWindowContainer;
               _loc3_.name = const_1389;
               _loc6_ = _loc3_.getChildByName(const_699) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2184.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1526).content as XML) as IWindowContainer;
               _loc3_.name = const_1391;
               _loc8_ = _loc3_.getChildByName(const_1041);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1390);
               if(_loc8_)
               {
      ...
      override protected function expose() : void
      {
         ...
         ITextWindow(_window.findChildByTag(const_1018)).underline = exposed;
      }
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_144)
         {
            ...
            _loc1_.findChildByName(const_699).caption = this.var_144.name;
            var_2184.crop(_loc1_.getChildByName(const_699) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_311));
            _loc2_.bitmap = var_594.getAvatarFaceBitmap(this.var_144.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_473.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1524).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1041:
               case const_1019:
                  this.removeNotificationToken(FriendNotification.const_423,true);
                  if(var_304 && this.var_144)
                  {
                     var_304.startConversation(this.var_144.id);
                     this.deselect(true);
                     if(param1.window.name == const_1019)
                     {
                        var_594.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1390:
                  if(var_304 && this.var_144)
                  {
                     var_304.followToRoom(this.var_144.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         {
            case FriendNotification.const_1245:
            ...
            case FriendNotification.const_1275:
               ...
               _loc5_ = const_691;
               break;
            case FriendNotification.const_423:
         ...
         if(_loc4_)
         {
            ...
            {
               _loc7_ = IItemListWindow(_window.findChildByName(const_378));
