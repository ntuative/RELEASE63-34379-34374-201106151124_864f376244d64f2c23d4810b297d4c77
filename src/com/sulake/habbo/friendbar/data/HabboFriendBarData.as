package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_312:Boolean = false;
      
      private static const const_1024:Boolean = false;
      
      private static const const_673:String = "Navigation";
      
      private static const const_672:String = "Friend Bar";
      
      private static const const_1400:String = "go.friendbar";
      
      private static const const_1402:String = "chat_btn_click";
      
      private static const const_1399:String = "find_friends_btn_click";
      
      private static const const_1025:String = "Toolbar";
      
      private static const const_1027:String = "open";
      
      private static const const_1026:String = "close";
      
      private static const const_1403:String = "FRIENDLIST";
      
      private static const const_1401:String = "MESSENGER";
      ...
      private var var_82:IHabboFriendList;
      
      private var var_210:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_82)
            {
               ...
               {
                  this.var_82.events.removeEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
                  this.var_82.events.removeEventListener(FriendRequestEvent.const_223,this.onFriendRequestEvent);
               }
               this.var_82.release(new IIDHabboFriendList());
               this.var_82 = null;
            }
            if(this.var_210)
            {
               this.var_210.release(new IIDHabboMessenger());
               this.var_210 = null;
            }
            this.var_109 = null;
      ...
      {
         return this.var_311.getValue(param1);
      }
      ...
      {
         var _loc3_:int = this.var_109.indexOf(param1);
         if(_loc3_ > -1 && _loc3_ != param2)
         {
            this.var_109.splice(_loc3_,1);
            this.var_109.splice(param2,0,param1);
      ...
      {
         return !!this.var_116 ? int(this.var_116.length) : 0;
      }
      
      public function getFriendRequestAt(param1:int) : FriendRequest
      {
         return !!this.var_116 ? this.var_116[param1] : null;
      }
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_82)
         {
            if(!this.var_82.disposed)
            {
               this.var_82.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_116 = null;
         this.var_82.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_82)
         {
            if(!this.var_82.disposed)
            {
               this.var_82.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_116 = null;
         this.var_82.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestUpdateEvent());
      }
      ...
      private function removeFriendRequest(param1:int) : void
      {
         ...
         if(this.var_116)
         {
            for each(_loc2_ in this.var_116)
            {
               if(_loc2_.id == param1)
               {
                  this.var_116.splice(this.var_116.indexOf(_loc2_),1);
                  events.dispatchEvent(new FriendRequestUpdateEvent());
                  return;
               }
            }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_673,const_672,const_1400));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_210)
         {
            this.var_210.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_92)
            {
               this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_673,const_672,const_1402));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_673,const_672,const_1399));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_82)
         {
            if(!this.var_82.disposed)
            {
               if(!this.var_82.isOpen())
               {
                  if(this.var_116.length > 0)
                  {
                     this.var_82.openFriendRequests();
                  }
                  else
                  {
                     this.var_82.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_82.mainWindow;
               ...
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1025,const_1403,!!this.var_82.isOpen() ? const_1027 : const_1026));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_210)
         {
            ...
            {
               this.var_210.toggleMessenger();
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1025,const_1401,!!this.var_210.isOpen() ? const_1027 : const_1026));
               }
            }
         }
      }
      ...
      {
         this.var_923 = param2 as IHabboConfigurationManager;
         this.var_2235 = this.var_923.getBoolean("friendbar.notifications.enabled",false);
         this.var_1688 = this.var_923.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_210 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_82 = param2 as IHabboFriendList;
         this.var_82.events.addEventListener(FriendRequestEvent.const_59,this.onFriendRequestEvent);
         this.var_82.events.addEventListener(FriendRequestEvent.const_223,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_311.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_311.remove(_loc8_);
               this.var_109.splice(this.var_109.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_311.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_312)
               {
                  ...
                  _loc3_.allowFollow = _loc4_.method_1;
               ...
               {
                  this.var_311.remove(_loc4_.id);
                  this.var_109.splice(this.var_109.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_312)
            {
               _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.method_1,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
               this.var_109.splice(0,0,_loc3_);
               this.var_311.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_312)
            {
               if(this.var_311.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.method_1,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_109 = !!const_312 ? this.sortByNameAndOnlineStatus(this.var_109) : this.sortByName(this.var_109);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         if(this.var_1688)
         {
            ...
            this.var_116.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName,_loc2_.figureString));
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         if(this.var_1688)
         {
            ...
            {
               this.var_116.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName,_loc3_.figureString));
            }
            events.dispatchEvent(new FriendRequestUpdateEvent());
         }
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_742 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_210)
         {
            if(this.var_210.isOpen())
            {
               _loc4_ = this.var_210.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_742)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_742));
            this.makeNotification(String(this.var_742),FriendNotification.const_423,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_742 = _loc2_.senderId;
         if(this.var_210 && !this.var_210.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_742));
            this.makeNotification(String(this.var_742),FriendNotification.const_423,null,true,false);
         }
      }
      ...
      private function buildFriendList(param1:Array) : void
      {
         ...
         {
            if(_loc2_.online || const_312)
            {
               _loc3_ = new FriendEntity(_loc2_.id,_loc2_.name,_loc2_.realName,_loc2_.motto,_loc2_.gender,_loc2_.online,_loc2_.method_1,_loc2_.figure,_loc2_.categoryId,_loc2_.lastAccess);
               this.var_109.push(_loc3_);
               this.var_311.add(_loc3_.id,_loc3_);
            }
         }
