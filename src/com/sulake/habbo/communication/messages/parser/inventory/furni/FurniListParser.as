package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_2993:String;
      
      protected var var_2992:int;
      
      protected var var_2991:int;
      
      protected var var_1671:Array;
      ...
      {
         this.var_2993 = param1.readString();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1671.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
