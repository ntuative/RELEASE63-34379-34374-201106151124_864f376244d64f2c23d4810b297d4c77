package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1571:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_229 = new Array(const_474);
         ...
         {
            this.var_229[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_667 = this.var_229[const_1608];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_1570 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1570);
            this.var_1571 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1571);
            this.var_1287 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_229)
            {
               ...
               {
                  IDisposable(this.var_229.pop()).dispose();
               }
            }
            this.var_229 = null;
            if(this.var_286)
      ...
      {
         return this.var_667.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_667.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_229[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_229[param2].getDesktopWindow();
      ...
      {
         return this.var_229[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_229[param1].getDesktopWindow().getChildAt(this.var_667.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_229[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_421.length > 0)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.var_229[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1287)
         ...
         {
            this.var_229[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1287)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1737,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1937,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1847,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1738,param2.name + ": " + param2.toString());
            }
         }
      }
