package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_208:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_182 && this._localization && this._friendList && this.var_762 && this._soundManager)
         {
            unlock();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_208 = new MessengerView(this);
      ...
      public function createConversation(param1:int) : Conversation
      {
         ...
         return new Conversation(_loc2_.id,_loc2_.name,_loc2_.figure,_loc2_.method_1);
      }
      ...
      {
         return this.var_208 && this.var_208.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_208)
         {
            if(this.var_208.isMessengerOpen())
            {
               this.var_208.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_995,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1305,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_208.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1184);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1322,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
