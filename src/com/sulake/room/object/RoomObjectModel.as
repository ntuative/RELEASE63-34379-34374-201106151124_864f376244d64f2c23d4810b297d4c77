package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_725)
            {
               delete this.var_725[_loc1_];
            }
            this.var_725 = null;
         }
      ...
      {
         var _loc2_:Array = this.var_725[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         if(this.var_1563.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1562.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1562.push(param1);
         }
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_725[param1];
