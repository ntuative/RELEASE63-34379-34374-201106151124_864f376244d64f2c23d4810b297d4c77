package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_383:int = 50;
      
      private static const const_1618:int = 50;
      
      private static const const_1113:Number = 60;
      
      private static const const_1619:Number = 50;
      ...
      private var var_1586:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2779:Number = -1.0E7;
      
      private var var_2785:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_292.addChild(this.var_113);
      ...
      {
         this.var_572.x -= param1 - this.var_690;
         this.var_690 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_572.y -= param1 - this.var_691;
         this.var_691 = param1;
      }
      ...
      {
         if(param1 && !this.var_986)
         {
            this.var_986 = true;
            if(this.var_154 != null && !this.var_292.contains(this.var_154))
            {
               this.var_292.addChild(this.var_154);
               this.var_113.mask = this.var_154;
            }
         }
         else if(!param1 && this.var_986)
         {
            this.var_986 = false;
            if(this.var_154 != null && this.var_292.contains(this.var_154))
            {
               this.var_292.removeChild(this.var_154);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_689 != null)
         {
            ...
            {
               this.cleanSprite(this.var_689[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_689 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_574 != this.var_2780 || this.var_573 != this.var_2783)
         {
            _loc8_ = true;
         }
         if(this.var_113.x != this.var_690 || this.var_113.y != this.var_691)
         {
            this.var_113.x = this.var_690;
            this.var_113.y = this.var_691;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2780 = this.var_574;
         this.var_2783 = this.var_573;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1587 > 0)
         {
            _loc2_ = param1 - this.var_1587;
            if(_loc2_ > const_1113 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2781 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_864;
               if(this.var_864 == const_383 + 1)
               {
                  this.var_516 = _loc2_;
                  this.var_2017 = this.var_2782;
               }
               else if(this.var_864 > const_383 + 1)
               {
                  _loc3_ = Number(this.var_864 - const_383);
                  this.var_516 = this.var_516 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2017 = this.var_2017 * (_loc3_ - 1) / _loc3_ + Number(this.var_2782) / _loc3_;
                  if(this.var_864 > const_383 + const_1618)
                  {
                     this.var_864 = const_383;
                     if(!this.var_1306 && this.var_516 > const_1113)
                     {
                        this.var_1306 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1306 && this.var_516 < const_1619)
                     {
                        this.var_1306 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2018 && this.var_1306);
         ...
         _loc13_ += int(this.var_574 / 2);
         _loc14_ += int(this.var_573 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
      ...
      {
         if(param1 < this.var_574 && param1 + param3 >= 0 && (param2 < this.var_573 && param2 + param4 >= 0))
         {
            if(!this.var_3039)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_574)
         {
            param3 -= this.var_574 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_573)
         {
            param4 -= this.var_573 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2784)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1054)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_689.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1054)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_693.identity();
            if(flipH)
            {
               this.var_693.scale(-1,1);
               this.var_693.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_693.scale(1,-1);
               this.var_693.translate(0,data.height);
            }
            finalData.draw(data,this.var_693);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_772.redMultiplier = tR;
            this.var_772.greenMultiplier = tG;
            this.var_772.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_772);
            if(name.length > 0)
            {
               this.var_293.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_690;
         param2 -= this.var_691;
         this.var_572.x = param1;
         this.var_572.y = param2;
         if(this.var_1307 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2019;
         }
         this.var_2019 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1307;
         return this.var_2019;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_574 / 2;
         var _loc12_:Number = param2 - this.var_573 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2020,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_688.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_688.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2779 || param2 != this.var_2785)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_688.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_688.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_398 != null && param1 != null)
         {
            this.var_398.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_398 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_398.getKey(_loc1_);
            _loc3_ = this.var_398.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1586.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1307 == 0)
         {
            this.checkMouseHits(this.var_572.x,this.var_572.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1307 = 0;
         ++this.var_2020;
      }
