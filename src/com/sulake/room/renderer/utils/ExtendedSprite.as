package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1573:int = 128;
      
      private var var_1574:Boolean = false;
      
      private var var_3037:Point;
      ...
      {
         if(param1 != this.var_1992 || param2 != this.var_1993)
         {
      ...
      {
         if(this.var_1573 > 255 || bitmapData == null)
         {
            return false;
         }
