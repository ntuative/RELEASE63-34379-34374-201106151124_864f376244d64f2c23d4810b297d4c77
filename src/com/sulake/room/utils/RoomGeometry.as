package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_553:Number = 64;
      
      public static const const_1343:Number = 32;
      ...
      private var var_1733:Number = 1.0;
      
      private var var_104:Vector3d;
      
      private var var_435:Vector3d;
      
      private var var_3021:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1733 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_434.assign(this.var_104);
         this.var_434.x *= this.var_438;
         this.var_434.y *= this.var_437;
         this.var_434.z *= this.var_436;
         return this.var_434;
      }
      ...
      {
         if(this.var_438 != param1 * this.var_1734)
         {
            this.var_438 = param1 * this.var_1734;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_437 != param1 * this.var_1732)
         {
            this.var_437 = param1 * this.var_1732;
            ++this.var_168;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1733)
         {
            this.var_436 = param1 * this.var_1733;
            ++this.var_168;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_104.x /= this.var_438;
         this.var_104.y /= this.var_437;
         this.var_104.z /= this.var_436;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_435.x;
         var _loc3_:Number = this.var_435.y;
         var _loc4_:Number = this.var_435.z;
         this.var_435.assign(param1);
         this._direction.assign(param1);
         if(this.var_435.x != _loc2_ || this.var_435.y != _loc3_ || this.var_435.z != _loc4_)
         {
            ++this.var_168;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1152.assign(this.var_186);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_517 != null)
         {
            ...
            this.var_517.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_517.add(_loc3_,_loc4_);
            ++this.var_168;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_517 != null)
         {
            ...
            return this.var_517.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1151.assign(_loc22_);
         }
         else
         {
            this.var_1151.assign(_loc17_);
         }
         ++this.var_168;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_437;
         _loc2_.z *= this.var_436;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1151);
         if(_loc3_ < this.var_3021 || _loc3_ > this.var_3022)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_437;
            _loc2_.z *= this.var_436;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1151);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_104.x * this.var_438,this.var_104.y * this.var_437,this.var_104.z * this.var_436);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_186;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_438,param2.y * this.var_437,param2.z * this.var_436);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_438,param3.y * this.var_437,param3.z * this.var_436);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_438,param4.y * this.var_437,param4.z * this.var_436);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1343;
         }
         else
         {
            this.scale = const_553;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_553;
      }
