package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      public static const const_1293:Boolean = false;
      ...
      protected var var_3074:uint = 0;
      
      protected var var_3010:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1293)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_875[_loc2_] as LibraryLoader;
            ...
            while(var_875.length < const_1902 && false)
            {
               _loc1_ = var_1079.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1132 ? uint(this.var_1404 - this.var_2232) : uint(getTimer() - this.var_2232);
      }
      ...
      {
         if(this.var_1133 && !_disposed)
         {
            this.var_1133 = false;
            if(!this.var_1132 && this.var_261)
            {
               this.var_1404 = -1;
      ...
      {
         if(!this.var_1132 && !_disposed && this.var_1403 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_261,const_1967 - this.var_1403);
            if(this.var_3010)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_505 = LibraryLoader.name_5;
         ...
         if(this.var_505 == LibraryLoader.const_2008)
         {
         ...
         if(this.var_505 == LibraryLoader.name_5)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_676 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_676.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
