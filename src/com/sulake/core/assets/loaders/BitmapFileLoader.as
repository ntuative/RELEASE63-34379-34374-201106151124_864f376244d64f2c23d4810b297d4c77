package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1134 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_45 = new Loader();
         this.var_1135 = new LoaderContext();
         this.var_1135.checkPolicyFile = true;
         ...
         {
            this.var_45.load(param2,this.var_1135);
         }
      }
      ...
      {
         this.var_1134 = param1.url;
         var_352 = 0;
         this.var_45.load(param1,this.var_1135);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_352 < var_2994)
            {
               ...
               this.var_45.load(new URLRequest(this.var_1134 + (this.var_1134.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_352),this.var_1135);
               return true;
            }
         }
         return false;
