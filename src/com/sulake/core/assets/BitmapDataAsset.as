package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1735:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            ...
            this.var_1565 = BitmapDataAsset(this.var_119).var_1565;
            this.var_1564 = BitmapDataAsset(this.var_119).var_1564;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1565 = _loc4_ == "1" || _loc4_ == "HabboRoomUICom_pet_command";
                  break;
               case "flipV":
                  this.var_1564 = _loc4_ == "1" || _loc4_ == "HabboRoomUICom_pet_command";
                  break;
            }
            _loc2_++;
         }
