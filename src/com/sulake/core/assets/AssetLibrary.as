package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1320:String = "AssetLibraryReady";
      
      public static const const_955:String = "AssetLibraryLoaded";
      
      public static const const_1838:String = "AssetLibraryUnloaded";
      
      public static const const_1816:String = "AssetLibraryLoadError";
      
      private static const const_699:String = "name";
      
      private static const const_1106:String = "asset";
      ...
      private static var var_335:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_567;
         this.var_468 = new Dictionary(false);
         this.var_568 = new Dictionary(false);
         this.var_1045 = new Dictionary(false);
         this.var_176 = new Dictionary(false);
         var_1043.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_677 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1108);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1106);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_699);
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_677 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1043.splice(var_1043.indexOf(this),1);
            --var_567;
            this.var_568 = null;
            this.var_1045 = null;
            this.var_176 = null;
      ...
      {
         if(this.var_677 == param1.url && this.var_1044)
         {
            if(!this.var_1042 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_676);
            }
            this.var_1042 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1320));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_176)
         {
            delete this.var_176[_loc1_];
         }
         ...
         this.var_1044 = false;
         this.var_677 = null;
         dispatchEvent(new Event(AssetLibrary.const_1838));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1045[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1226,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1290,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1303,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_176[struct.assetName] == null)
                  {
                     ++this.var_469;
                     this.var_470.push(struct.assetName);
                  }
                  this.var_176[struct.assetName] = asset;
               }
               else
               {
      ...
      {
         var _loc2_:IAsset = this.var_176[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_470.length ? this.getAssetByName(this.var_470[param1]) : null;
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_176)
         {
            _loc3_ = this.var_176[_loc2_];
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_176)
         {
            if(this.var_176[_loc2_] == param1)
            {
               return this.var_470.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_176[param1] != null || (this.var_676 != null ? this.var_676[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_176[param1] == null;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_176)
            {
               if(this.var_176[_loc2_] == param1)
               {
                  this.var_470.splice(this.var_470.indexOf(_loc2_),1);
                  delete this.var_176[_loc2_];
                  --this.var_469;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_335.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_335[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_468.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_468[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_335[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_468[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_335)
            {
               _loc3_ = AssetTypeDeclaration(var_335[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_468)
         {
            _loc3_ = AssetTypeDeclaration(this.var_468[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_335)
            {
               _loc4_ = AssetTypeDeclaration(var_335[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_468)
         {
            _loc4_ = AssetTypeDeclaration(this.var_468[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_676 = _loc2_.resource;
         this.var_677 = _loc2_.url;
         if(this.var_1042)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_676);
         }
         this.var_1044 = true;
         dispatchEvent(new Event(AssetLibrary.const_955));
         dispatchEvent(new Event(AssetLibrary.const_1320));
         if(this.var_1042)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1816));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1108);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1106);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_699) && _loc3_.attribute(const_699).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_677 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_676[param1]);
