package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_459:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2192:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1264:uint = 4;
       
      
      protected var var_900:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1387 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1387);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1566 & const_1264)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_931 = false;
            this._events.dispatchEvent(new LockEvent(const_459,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_900 + "]";
      }
