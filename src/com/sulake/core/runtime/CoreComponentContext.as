package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1585:String = "asset-libraries";
      
      private static const const_1589:String = "library";
      
      private static const const_1587:String = "service-libraries";
      
      private static const const_1584:String = "library";
      
      private static const const_1590:String = "component-libraries";
      
      private static const const_1582:String = "library";
      
      private static const const_1583:String = "error_data";
      
      private static const const_1588:String = "error_cat";
      
      private static const const_1586:String = "error_desc";
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_876:
               ...
               this.var_228 = new Profiler(this);
               attachComponent(this.var_228,[new IIDProfiler()]);
               var_422.addChild(new ProfilerViewer(this.var_228));
               break;
            case Core.const_524:
      ...
      {
         return this.var_563 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_285[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1583,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1588,String(param3));
         ErrorReportStorage.setParameter(const_1586,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1585)[0];
            if(node != null)
            {
               list = node.child(const_1589);
         ...
         try
         {
            node = config.child(const_1587)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1590)[0];
            if(node != null)
            {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_840)
                  {
                     this.var_840.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_563 - this.var_390.length,this.var_563,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_228 ? 0 : this.var_1566 & 0;
         if(_loc3_ == Core.const_524)
         {
            this.var_285[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_285[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_228 ? 0 : this.var_1566 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_107)
         {
            _loc3_ = this.var_285[_loc5_] as Array;
            if(_loc4_ == Core.const_524)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            receivers = this.var_285[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_228.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
