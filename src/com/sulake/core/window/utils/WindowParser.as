package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1301:String = "_EXCLUDE";
      
      public static const const_2229:String = "_INCLUDE";
      
      public static const const_2245:String = "_TEMP";
      
      private static const const_1580:String = "layout";
      
      private static const const_1101:String = "window";
      
      private static const const_1102:String = "variables";
      
      private static const const_1103:String = "filters";
      
      private static const const_699:String = "name";
      
      private static const const_1567:String = "style";
      
      private static const const_700:String = "params";
      
      private static const const_1570:String = "tags";
      ...
      private static const const_1572:String = "visible";
      
      private static const const_1581:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1160:String = "blend";
      
      private static const const_1579:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1569:String = "treshold";
      
      private static const const_1576:String = "children";
      
      private static const const_1574:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1577:String = "height_min";
      
      private static const const_1578:String = "height_max";
      
      private static const const_698:String = "HabboRoomUICom_pet_command";
      
      private static const const_175:String = "0";
      
      private static const const_1571:String = "$";
      
      private static const const_1575:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1573:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1128,this.var_1676);
         this.var_2222 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1568,const_50);
         return param1.replace(const_1573,const_50);
      }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1580)
         {
            _loc8_ = param1.child(const_1102);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1103).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1101);
         ...
         if(param1.localName() == const_1101)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_699,variables,"")));
         style = uint(this.parseAttribute(xml,const_1567,variables,style));
         params = uint(this.parseAttribute(xml,const_700,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1570,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_175));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_175));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_175));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_175));
         visible = this.parseAttribute(xml,const_1572,variables,visible.toString()) == const_698;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_700).length() > 0)
         {
            list = xml.child(const_700).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_699,variables,"") as String;
               if(this.var_1128[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_699)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1581,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1575);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1102)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1574,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1577,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1578,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_698;
         blend = Number(this.parseAttribute(xml,const_1160,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1579,variables,window.clipping.toString()) == const_698;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1569,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1103).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1301) == -1)
                  {
