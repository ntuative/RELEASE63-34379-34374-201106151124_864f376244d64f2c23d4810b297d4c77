package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_221:String = "regular";
      ...
      private static const const_683:String = "{";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_221],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_221] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboRoomUICom_pet_command" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_682);
         if(countSubStrings(param1,const_683) != countSubStrings(param1,const_682))
         {
            throw new Error("Mismatching amount of \"" + const_683 + "\" versus \"" + const_682 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_683)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
