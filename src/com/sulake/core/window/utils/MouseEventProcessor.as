package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_915:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_357 = new Array();
            var_357[0] = MouseCursorType.const_322;
            var_357[1] = MouseCursorType.const_31;
            var_357[2] = MouseCursorType.const_322;
            var_357[3] = MouseCursorType.const_322;
            var_357[4] = MouseCursorType.const_322;
            var_357[5] = MouseCursorType.const_31;
            var_357[6] = MouseCursorType.const_322;
         }
         if(var_310 == null)
         {
            var_310 = new Array();
            var_310[0] = WindowState.const_90;
            var_310[1] = WindowState.const_94;
            var_310[2] = WindowState.const_91;
            var_310[3] = WindowState.const_69;
            var_310[4] = WindowState.const_55;
            var_310[5] = WindowState.const_95;
            var_310[6] = WindowState.const_88;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1383 as WindowController;
         this.var_189 = state.var_1385 as WindowController;
         this.var_175 = state.renderer;
         this.var_915 = state.var_1384;
         eventQueue.begin();
         this.var_736.x = -1;
         this.var_736.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_736.x || event.stageY != this.var_736.y)
            {
               this.var_736.x = event.stageX;
               this.var_736.y = event.stageY;
               array = new Array();
               this.var_95.groupParameterFilteredChildrenUnderPoint(this.var_736,array,WindowParam.const_30);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_915.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1383 = this.var_71;
         state.var_1385 = this.var_189;
         state.renderer = this.var_175;
         state.var_1384 = this.var_915;
      }
