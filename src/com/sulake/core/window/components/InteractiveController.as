package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1672 = PropertyDefaults.const_850;
         this.var_1393 = PropertyDefaults.const_414;
         param4 |= 0;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_414)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_991,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
         ...
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1001,param1.toolTipDelay,PropertyStruct.const_282,true));
         }
         else
         {
