package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1035:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1969:StyleSheet = null;
      ...
      {
         this.var_836 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_865.indexOf(param1) > -1)
         {
            this.var_836 = param1;
         }
      }
      ...
      {
         return this.var_836 == LinkTarget.const_31 ? defaultLinkTarget : this.var_836;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1969;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1172)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_836 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_813,this.var_836,PropertyStruct.const_52,true,PropertyDefaults.const_865));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_813)
            {
               this.var_836 = _loc2_.value as String;
               break;
            }
