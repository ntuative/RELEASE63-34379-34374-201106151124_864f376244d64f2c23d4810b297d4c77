package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1228:IItemListWindow;
      
      private var var_447:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_447)
         {
            this.var_447.removeEventListener(WindowEvent.const_309,this.scrollBarEventProc);
            this.var_447.removeEventListener(WindowEvent.const_290,this.scrollBarEventProc);
            this.var_447 = null;
         }
         if(this.var_1228)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1228)
         {
            this.var_1228 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_447)
         {
            this.var_447 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_447)
            {
               this.var_447.addEventListener(WindowEvent.const_309,this.scrollBarEventProc);
               this.var_447.addEventListener(WindowEvent.const_290,this.scrollBarEventProc);
            }
         }
         return this.var_447;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_290)
         {
            this.hideScrollBar();
         }
      }
