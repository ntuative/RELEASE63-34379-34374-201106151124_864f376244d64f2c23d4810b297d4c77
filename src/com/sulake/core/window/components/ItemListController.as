package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2211:Boolean = false;
      
      protected var var_595:Boolean = false;
      ...
      protected var var_423:Boolean;
      
      protected var var_1122:Boolean;
      
      protected var var_2210:int = 0;
      
      protected var var_2212:int = 0;
      ...
      {
         this._spacing = PropertyDefaults.const_661;
         this.var_912 = PropertyDefaults.const_815;
         this.var_423 = PropertyDefaults.const_925;
         this.var_1122 = PropertyDefaults.const_770;
         this.var_733 = 0;
         this.var_732 = 0;
         this.var_122 = 0;
         this.var_107 = 0;
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_452,WindowStyle.const_101,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_202,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1122;
      }
      ...
      {
         return new Rectangle(this.var_733 * this.maxScrollH,this.var_732 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_733)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_564,this,null);
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_202,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1389)
               {
                  this.var_1388 = this.var_2210 - _loc3_;
                  this.var_1390 = this.var_2212 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1388 != 0 && this.var_122 != 0)
                     {
                        this.scrollH += this.var_1388 / this.var_122;
                     }
                  }
                  else if(this.var_1390 != 0 && this.var_107 != 0)
                  {
                     this.scrollV += this.var_1390 / this.var_107;
                  }
                  this.var_2210 = _loc3_;
                  this.var_2212 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_296:
               if(this.var_1389)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1388,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1390);
                  }
                  this.var_1389 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_912 && !this.var_595 && this._container)
         {
            this.var_595 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_661)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_416,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1340);
         }
         if(this.var_912 != PropertyDefaults.const_815)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_738,this.var_912,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1782);
         }
         if(this.var_423 != PropertyDefaults.const_925)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_886,this.var_423,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1947);
         }
         if(this.var_1122 != PropertyDefaults.const_770)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_913,this.var_1122,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1746);
         }
         if(this.var_734 != PropertyDefaults.const_1357)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1008,this.var_734,PropertyStruct.const_138,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1928);
         }
         if(this.var_731 != PropertyDefaults.const_1229)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_728,this.var_731,PropertyStruct.const_138,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_738:
                  this.var_912 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_1008:
