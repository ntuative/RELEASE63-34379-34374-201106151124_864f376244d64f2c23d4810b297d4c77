package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_797:Boolean = false;
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_797 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_193,event,this,null);
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_19 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_375,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_899,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1721);
         _loc1_.push(this.var_1399 != PropertyDefaults.const_1317 ? new PropertyStruct(PropertyDefaults.const_943,this.var_1399,PropertyStruct.const_37,true) : PropertyDefaults.const_1739);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1199 ? new PropertyStruct(PropertyDefaults.const_1007,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1704);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1382 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1962);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_943:
                  this.var_1399 = _loc2_.value as Boolean;
                  if(this.var_1399)
                  {
               ...
               case PropertyDefaults.const_899:
                  ...
                  break;
               case PropertyDefaults.const_1217:
