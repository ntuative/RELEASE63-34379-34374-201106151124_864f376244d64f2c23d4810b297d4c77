package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1497:String = "_SELECTOR";
      
      private static const const_1496:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1123 = findChildByTag(const_1497) as ITabSelectorWindow;
            if(this.var_1123 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2215 = findChildByTag(const_1496) as IWindowContainer;
         }
      ...
      {
         return !!this.var_797 ? this.selector.iterator : null;
      }
