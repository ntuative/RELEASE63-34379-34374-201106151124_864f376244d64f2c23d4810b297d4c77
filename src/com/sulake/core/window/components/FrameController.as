package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1676:String = "_HEADER";
      
      private static const const_1674:String = "_CONTENT";
      
      private static const const_1675:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1634:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1634 = findChildByTag(const_1676) as IHeaderWindow;
            if(!this.var_1634)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_201 = findChildByTag(const_1674) as IWindowContainer;
            if(!this.var_201)
            {
      ...
      {
         return findChildByTag(const_1675) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1386,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1132 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_372);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_286);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_285,_loc3_.left,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_308,_loc3_.top,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_279,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_306,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         return _loc1_;
      }
