package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1388:Dictionary = createPropertySetterTable();
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_221);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_875 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_920 * this.maxScrollH,this.var_597 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_989,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1327));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1263 ? new PropertyStruct(PropertyDefaults.const_906,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1311) : PropertyDefaults.const_1720);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_282,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1209 ? new PropertyStruct(PropertyDefaults.const_1241,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1336) : PropertyDefaults.const_1895);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1011) ? new PropertyStruct(PropertyDefaults.const_441,this._field.textColor,PropertyStruct.const_145,true) : PropertyDefaults.const_1194);
         ...
         _loc1_.push(this.var_44.left != PropertyDefaults.const_953 ? new PropertyStruct(PropertyDefaults.const_285,this.var_44.left,PropertyStruct.const_40,true) : PropertyDefaults.const_891);
         _loc1_.push(this.var_44.top != PropertyDefaults.const_972 ? new PropertyStruct(PropertyDefaults.const_308,this.var_44.top,PropertyStruct.const_40,true) : PropertyDefaults.const_914);
         _loc1_.push(this.var_44.right != PropertyDefaults.const_856 ? new PropertyStruct(PropertyDefaults.const_279,this.var_44.right,PropertyStruct.const_40,true) : PropertyDefaults.const_971);
         _loc1_.push(this.var_44.bottom != PropertyDefaults.const_758 ? new PropertyStruct(PropertyDefaults.const_306,this.var_44.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_919);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1181 ? new PropertyStruct(PropertyDefaults.const_956,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1742);
