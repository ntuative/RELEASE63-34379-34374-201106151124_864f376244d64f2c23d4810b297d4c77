package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1482:String = "skin";
      
      private static const const_1485:String = "bitmap";
      
      private static const const_1483:String = "fill";
      
      private static const const_1480:String = "text";
      
      private static const const_1481:String = "label";
      
      private static const const_1484:String = "shape";
      ...
      private var var_2435:Dictionary;
      
      private var var_2434:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2435 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1817,this.var_2435);
         this.var_2434 = new Dictionary();
         this.var_2433 = new Dictionary();
         StateCodeTable.fillTables(this.var_2434,this.var_2433);
         this.var_441 = new Dictionary();
         this.var_441[const_1482] = BitmapSkinRenderer;
         this.var_441[const_1485] = BitmapDataRenderer;
         this.var_441[const_1483] = FillSkinRenderer;
         this.var_441[const_1480] = TextSkinRenderer;
         this.var_441[const_1481] = LabelRenderer;
         this.var_441[const_1484] = ShapeSkinRenderer;
         this.var_441[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_441[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_356 == null)
         {
            var_356 = new Array();
            var_356.push(WindowState.const_69);
            var_356.push(WindowState.const_88);
            var_356.push(WindowState.const_95);
            var_356.push(WindowState.const_55);
            var_356.push(WindowState.const_91);
            var_356.push(WindowState.const_94);
            var_356.push(WindowState.const_90);
            var_356.push(WindowState.const_105);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2987 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboRoomUICom_pet_command" : false;
                  ...
                  this.addSkinRenderer(this.var_1817[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_971[param1] == null)
         {
            this.var_971[param1] = new Array(const_1058);
         }
         this.var_971[param1][param2] = param3;
         if(this.var_972[param1] == null)
         {
            this.var_972[param1] = new Array(const_1058);
         }
         this.var_972[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_971[param1];
         if(_loc3_)
         {
